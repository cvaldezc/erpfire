...
module Application.Controllers {
    ...
    export class MyController {
        ...
        constructor($scope: ng.IScope, myService: Services.MyService) {
            this.scope = $scope;
...
app.service('MyService', Application.Services.MyService);

app.controller('ctrlpurchase', Application.Controllers.MyController);
...
//         public static $inject = ['$http', '$cookies'];

//         constructor(private $http: ng.IHttpService, private $cookies: ng.cookies.ICookiesService) {
//             this.$http.defaults.headers.post['X-CSRFToken'] = this.$cookies['csrftoken'];
...
//             let params: object = this.purchase['fields'];
//             params['observation'] = angular.element("#observation").trumbowyg('html');
//             params['projects'] = params['projects'].join();
//             let deposit: HTMLInputElement = <HTMLInputElement>angular.element("#deposit")[0];
...
// app.service('Proxy', PurchaseModule.Proxy);

// app.controller('ctrlpurchase', PurchaseModule.PurchaseController);
