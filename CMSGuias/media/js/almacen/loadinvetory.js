...
controller = function($scope, $timeout, $q, inventoryFactory) {
  ...
  $scope.openAdjustQuantity = function(obj) {
    angular.element("#madjust").modal('open');
    $scope.adjust = obj;
  };
  $scope.adjustStock = function() {
    var param;
    Materialize.toast('Procesando...!', void 0, 'toast-remove');
    param = {
      adjustStk: true,
    ...
    inventoryFactory.post(param).then((function(response) {
