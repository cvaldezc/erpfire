...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmployeeAuditLogEntry.enfermedad'
        db.add_column(u'home_employeeauditlogentry', 'enfermedad',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmployeeAuditLogEntry.medicamento'
        db.add_column(u'home_employeeauditlogentry', 'medicamento',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmployeeAuditLogEntry.tratamiento'
        db.add_column(u'home_employeeauditlogentry', 'tratamiento',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmployeeAuditLogEntry.quirurgica'
        db.add_column(u'home_employeeauditlogentry', 'quirurgica',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Employee.enfermedad'
        db.add_column(u'home_employee', 'enfermedad',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employee.medicamento'
        db.add_column(u'home_employee', 'medicamento',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employee.tratamiento'
        db.add_column(u'home_employee', 'tratamiento',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Employee.quirurgica'
        db.add_column(u'home_employee', 'quirurgica',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EmployeeAuditLogEntry.enfermedad'
        db.delete_column(u'home_employeeauditlogentry', 'enfermedad')

        # Deleting field 'EmployeeAuditLogEntry.medicamento'
        db.delete_column(u'home_employeeauditlogentry', 'medicamento')

        # Deleting field 'EmployeeAuditLogEntry.tratamiento'
        db.delete_column(u'home_employeeauditlogentry', 'tratamiento')

        # Deleting field 'EmployeeAuditLogEntry.quirurgica'
        db.delete_column(u'home_employeeauditlogentry', 'quirurgica')
        ...
        # Deleting field 'Employee.enfermedad'
        db.delete_column(u'home_employee', 'enfermedad')

        # Deleting field 'Employee.medicamento'
        db.delete_column(u'home_employee', 'medicamento')

        # Deleting field 'Employee.tratamiento'
        db.delete_column(u'home_employee', 'tratamiento')

        # Deleting field 'Employee.quirurgica'
        db.delete_column(u'home_employee', 'quirurgica')
    ...
    models = {
        ...
        u'home.employee': {
            ...
            'enfermedad': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'medicamento': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'quirurgica': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'tratamiento': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'})
        },
