...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AreaCargo'
        db.create_table(u'home_areacargo', (
            ('area_id', self.gf('django.db.models.fields.CharField')(max_length=4, primary_key=True)),
        ...
        db.send_create_signal(u'home', ['AreaCargo'])


    def backwards(self, orm):
        # Deleting model 'AreaCargo'
        db.delete_table(u'home_areacargo')
    ...
    models = {
        ...
        u'home.areacargo': {
            'Meta': {'object_name': 'AreaCargo'},
            'area': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'area_id': ('django.db.models.fields.CharField', [], {'max_length': '4', 'primary_key': 'True'}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
        u'home.brand': {
