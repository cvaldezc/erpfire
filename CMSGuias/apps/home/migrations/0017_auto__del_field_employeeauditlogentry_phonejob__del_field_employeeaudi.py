...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmployeeAuditLogEntry.estadoplan'
        db.add_column(u'home_employeeauditlogentry', 'estadoplan',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'EmployeeAuditLogEntry.birth'
        db.alter_column(u'home_employeeauditlogentry', 'birth', self.gf('django.db.models.fields.DateField')())
        ...
        # Adding field 'Employee.estadoplan'
        db.add_column(u'home_employee', 'estadoplan',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
        ...
        db.alter_column(u'home_employee', 'birth', self.gf('django.db.models.fields.DateField')())
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EmployeeAuditLogEntry.estadoplan'
        db.delete_column(u'home_employeeauditlogentry', 'estadoplan')


        # Changing field 'EmployeeAuditLogEntry.birth'
        db.alter_column(u'home_employeeauditlogentry', 'birth', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
        ...
        # Deleting field 'Employee.estadoplan'
        db.delete_column(u'home_employee', 'estadoplan')
        ...
        # Changing field 'Employee.birth'
        db.alter_column(u'home_employee', 'birth', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        u'home.employee': {
            ...
            'address2': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '180'}),
            ...
            'estadoplan': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'situacion': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
