...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EmployeeSettingsAuditLogEntry.outsaturday'
        db.delete_column(u'home_employeesettingsauditlogentry', 'outsaturday')

        # Deleting field 'EmployeeSettings.outsaturday'
        db.delete_column(u'home_employeesettings', 'outsaturday')


    def backwards(self, orm):
        # Adding field 'EmployeeSettingsAuditLogEntry.outsaturday'
        db.add_column(u'home_employeesettingsauditlogentry', 'outsaturday',
                      self.gf('django.db.models.fields.TimeField')(default='00:00:00', null=True, blank=True),
                      keep_default=False)

        # Adding field 'EmployeeSettings.outsaturday'
        db.add_column(u'home_employeesettings', 'outsaturday',
                      self.gf('django.db.models.fields.TimeField')(default='00:00:00', null=True, blank=True),
                      keep_default=False)
