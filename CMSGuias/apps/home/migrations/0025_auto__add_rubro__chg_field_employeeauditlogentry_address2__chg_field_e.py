...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmployeeAuditLogEntry.address2'
        db.alter_column(u'home_employeeauditlogentry', 'address2', self.gf('django.db.models.fields.CharField')(max_length=180, null=True))
        ...
        # Changing field 'Employee.address2'
        db.alter_column(u'home_employee', 'address2', self.gf('django.db.models.fields.CharField')(max_length=180, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EmployeeAuditLogEntry.address2'
        db.alter_column(u'home_employeeauditlogentry', 'address2', self.gf('django.db.models.fields.CharField')(default=None, max_length=180))

        # Changing field 'EmployeeAuditLogEntry.birth'
        db.alter_column(u'home_employeeauditlogentry', 'birth', self.gf('django.db.models.fields.DateField')(default=None))
        ...
        # Changing field 'Employee.address2'
        db.alter_column(u'home_employee', 'address2', self.gf('django.db.models.fields.CharField')(default=None, max_length=180))

        # Changing field 'Employee.birth'
        db.alter_column(u'home_employee', 'birth', self.gf('django.db.models.fields.DateField')(default=None))
