...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SettingsApp'
        db.create_table(u'home_settingsapp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('serverreport', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
            ('servermail', self.gf('django.db.models.fields.CharField')(default='', max_length=255)),
        ...
        db.send_create_signal(u'home', ['SettingsApp'])


    def backwards(self, orm):
        # Deleting model 'SettingsApp'
        db.delete_table(u'home_settingsapp')
