...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmployeeSettingsAuditLogEntry.codeproject'
        db.add_column(u'home_employeesettingsauditlogentry', 'codeproject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, null=True),
                      keep_default=False)

        # Adding field 'EmployeeSettings.codeproject'
        db.add_column(u'home_employeesettings', 'codeproject',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=4, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmployeeSettingsAuditLogEntry.codeproject'
        db.delete_column(u'home_employeesettingsauditlogentry', 'codeproject')

        # Deleting field 'EmployeeSettings.codeproject'
        db.delete_column(u'home_employeesettings', 'codeproject')
