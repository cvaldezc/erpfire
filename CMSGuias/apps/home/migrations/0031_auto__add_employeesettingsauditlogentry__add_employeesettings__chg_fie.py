...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Proveedor.rubropro'
        db.alter_column(u'home_proveedor', 'rubropro_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Rubro'], null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Proveedor.rubropro'
        db.alter_column(u'home_proveedor', 'rubropro_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Rubro']))
