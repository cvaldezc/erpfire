...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmployeeSettingsAuditLogEntry.shxsaturday'
        db.add_column(u'home_employeesettingsauditlogentry', 'shxsaturday',
                      self.gf('django.db.models.fields.TimeField')(default='15:00:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettingsAuditLogEntry.shxsaturdayt'
        db.add_column(u'home_employeesettingsauditlogentry', 'shxsaturdayt',
                      self.gf('django.db.models.fields.TimeField')(default='17:00:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettings.shxsaturday'
        db.add_column(u'home_employeesettings', 'shxsaturday',
                      self.gf('django.db.models.fields.TimeField')(default='15:00:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettings.shxsaturdayt'
        db.add_column(u'home_employeesettings', 'shxsaturdayt',
                      self.gf('django.db.models.fields.TimeField')(default='17:00:00'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmployeeSettingsAuditLogEntry.shxsaturday'
        db.delete_column(u'home_employeesettingsauditlogentry', 'shxsaturday')

        # Deleting field 'EmployeeSettingsAuditLogEntry.shxsaturdayt'
        db.delete_column(u'home_employeesettingsauditlogentry', 'shxsaturdayt')

        # Deleting field 'EmployeeSettings.shxsaturday'
        db.delete_column(u'home_employeesettings', 'shxsaturday')

        # Deleting field 'EmployeeSettings.shxsaturdayt'
        db.delete_column(u'home_employeesettings', 'shxsaturdayt')
