...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmployeeSettingsAuditLogEntry.ncts'
        db.add_column(u'home_employeesettingsauditlogentry', 'ncts',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'EmployeeSettingsAuditLogEntry.pergratification'
        db.add_column(u'home_employeesettingsauditlogentry', 'pergratification',
                      self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'EmployeeSettingsAuditLogEntry.starthourextra'
        db.add_column(u'home_employeesettingsauditlogentry', 'starthourextra',
                      self.gf('django.db.models.fields.TimeField')(default='09:00:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettingsAuditLogEntry.starthourextratwo'
        db.add_column(u'home_employeesettingsauditlogentry', 'starthourextratwo',
                      self.gf('django.db.models.fields.TimeField')(default='12:00:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettingsAuditLogEntry.totalhour'
        db.add_column(u'home_employeesettingsauditlogentry', 'totalhour',
                      self.gf('django.db.models.fields.TimeField')(default='08:30:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettingsAuditLogEntry.timeround'
        db.add_column(u'home_employeesettingsauditlogentry', 'timeround',
                      self.gf('django.db.models.fields.TimeField')(default='00:30:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettingsAuditLogEntry.flag'
        db.add_column(u'home_employeesettingsauditlogentry', 'flag',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'EmployeeSettings.ncts'
        db.add_column(u'home_employeesettings', 'ncts',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)

        # Adding field 'EmployeeSettings.pergratification'
        db.add_column(u'home_employeesettings', 'pergratification',
                      self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=5, decimal_places=2),
                      keep_default=False)

        # Adding field 'EmployeeSettings.starthourextra'
        db.add_column(u'home_employeesettings', 'starthourextra',
                      self.gf('django.db.models.fields.TimeField')(default='09:00:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettings.starthourextratwo'
        db.add_column(u'home_employeesettings', 'starthourextratwo',
                      self.gf('django.db.models.fields.TimeField')(default='12:00:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettings.totalhour'
        db.add_column(u'home_employeesettings', 'totalhour',
                      self.gf('django.db.models.fields.TimeField')(default='08:30:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettings.timeround'
        db.add_column(u'home_employeesettings', 'timeround',
                      self.gf('django.db.models.fields.TimeField')(default='00:30:00'),
                      keep_default=False)

        # Adding field 'EmployeeSettings.flag'
        db.add_column(u'home_employeesettings', 'flag',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmployeeSettingsAuditLogEntry.ncts'
        db.delete_column(u'home_employeesettingsauditlogentry', 'ncts')

        # Deleting field 'EmployeeSettingsAuditLogEntry.pergratification'
        db.delete_column(u'home_employeesettingsauditlogentry', 'pergratification')

        # Deleting field 'EmployeeSettingsAuditLogEntry.starthourextra'
        db.delete_column(u'home_employeesettingsauditlogentry', 'starthourextra')

        # Deleting field 'EmployeeSettingsAuditLogEntry.starthourextratwo'
        db.delete_column(u'home_employeesettingsauditlogentry', 'starthourextratwo')

        # Deleting field 'EmployeeSettingsAuditLogEntry.totalhour'
        db.delete_column(u'home_employeesettingsauditlogentry', 'totalhour')

        # Deleting field 'EmployeeSettingsAuditLogEntry.timeround'
        db.delete_column(u'home_employeesettingsauditlogentry', 'timeround')

        # Deleting field 'EmployeeSettingsAuditLogEntry.flag'
        db.delete_column(u'home_employeesettingsauditlogentry', 'flag')

        # Deleting field 'EmployeeSettings.ncts'
        db.delete_column(u'home_employeesettings', 'ncts')

        # Deleting field 'EmployeeSettings.pergratification'
        db.delete_column(u'home_employeesettings', 'pergratification')

        # Deleting field 'EmployeeSettings.starthourextra'
        db.delete_column(u'home_employeesettings', 'starthourextra')

        # Deleting field 'EmployeeSettings.starthourextratwo'
        db.delete_column(u'home_employeesettings', 'starthourextratwo')

        # Deleting field 'EmployeeSettings.totalhour'
        db.delete_column(u'home_employeesettings', 'totalhour')

        # Deleting field 'EmployeeSettings.timeround'
        db.delete_column(u'home_employeesettings', 'timeround')

        # Deleting field 'EmployeeSettings.flag'
        db.delete_column(u'home_employeesettings', 'flag')
    ...
    models = {
        ...
        u'home.employeesettings': {
            ...
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'hextperfirst': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '3', 'decimal_places': '2'}),
            'hextpersecond': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '3', 'decimal_places': '2'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'starthourextratwo': ('django.db.models.fields.TimeField', [], {'default': "'12:00:00'"}),
