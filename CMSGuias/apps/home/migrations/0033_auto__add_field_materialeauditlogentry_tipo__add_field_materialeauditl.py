...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MaterialeAuditLogEntry.tipo'
        db.add_column(u'home_materialeauditlogentry', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='MT', max_length=2),
                      keep_default=False)

        # Adding field 'MaterialeAuditLogEntry.weight'
        db.add_column(u'home_materialeauditlogentry', 'weight',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'MaterialeAuditLogEntry.register'
        db.add_column(u'home_materialeauditlogentry', 'register',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2017, 7, 19, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Materiale.tipo'
        db.add_column(u'home_materiale', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='MT', max_length=2),
                      keep_default=False)

        # Adding field 'Materiale.weight'
        db.add_column(u'home_materiale', 'weight',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Materiale.register'
        db.add_column(u'home_materiale', 'register',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2017, 7, 19, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'MaterialeAuditLogEntry.tipo'
        db.delete_column(u'home_materialeauditlogentry', 'tipo')

        # Deleting field 'MaterialeAuditLogEntry.weight'
        db.delete_column(u'home_materialeauditlogentry', 'weight')

        # Deleting field 'MaterialeAuditLogEntry.register'
        db.delete_column(u'home_materialeauditlogentry', 'register')

        # Deleting field 'Materiale.tipo'
        db.delete_column(u'home_materiale', 'tipo')

        # Deleting field 'Materiale.weight'
        db.delete_column(u'home_materiale', 'weight')

        # Deleting field 'Materiale.register'
        db.delete_column(u'home_materiale', 'register')
    ...
    models = {
        ...
        u'home.settingsapp': {
            'Meta': {'object_name': 'SettingsApp'},
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'servermail': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'}),
            'serverreport': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255'})
        },
        u'home.tipocambio': {
