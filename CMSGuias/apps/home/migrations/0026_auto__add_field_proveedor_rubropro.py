...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Proveedor.rubropro'
        db.add_column(u'home_proveedor', 'rubropro',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='RU002', to=orm['home.Rubro']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Proveedor.rubropro'
        db.delete_column(u'home_proveedor', 'rubropro_id')
