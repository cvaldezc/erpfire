...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EmployeeAuditLogEntry.situacio'
        db.delete_column(u'home_employeeauditlogentry', 'situacio')

        # Adding field 'EmployeeAuditLogEntry.situacion'
        db.add_column(u'home_employeeauditlogentry', 'situacion',
                      self.gf('django.db.models.fields.CharField')(default='Activo', max_length=100),
                      keep_default=False)
        ...
        # Deleting field 'Employee.situacio'
        db.delete_column(u'home_employee', 'situacio')
    ...
    def backwards(self, orm):
        # Adding field 'EmployeeAuditLogEntry.situacio'
        db.add_column(u'home_employeeauditlogentry', 'situacio',
        ...
        # Changing field 'EmployeeAuditLogEntry.nacionalidad'
        db.alter_column(u'home_employeeauditlogentry', 'nacionalidad', self.gf('django.db.models.fields.BooleanField')())
        # Adding field 'Employee.situacio'
        db.add_column(u'home_employee', 'situacio',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
        ...
        # Changing field 'Employee.nacionalidad'
        db.alter_column(u'home_employee', 'nacionalidad', self.gf('django.db.models.fields.BooleanField')())
    ...
    models = {
        ...
        u'home.employee': {
            ...
            'nacionalidad': ('django.db.models.fields.CharField', [], {'default': "'Peru'", 'max_length': '50'}),
            ...
            'situacion': ('django.db.models.fields.CharField', [], {'default': "'Activo'", 'max_length': '100'}),
