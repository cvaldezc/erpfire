...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmployeeAuditLogEntry.nacionalidad'
        db.alter_column(u'home_employeeauditlogentry', 'nacionalidad', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'EmployeeAuditLogEntry.situacion'
        db.alter_column(u'home_employeeauditlogentry', 'situacion', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
        ...
        # Changing field 'Employee.situacion'
        db.alter_column(u'home_employee', 'situacion', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'Employee.nacionalidad'
        db.alter_column(u'home_employee', 'nacionalidad', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EmployeeAuditLogEntry.nacionalidad'
        db.alter_column(u'home_employeeauditlogentry', 'nacionalidad', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'EmployeeAuditLogEntry.situacion'
        db.alter_column(u'home_employeeauditlogentry', 'situacion', self.gf('django.db.models.fields.CharField')(max_length=100))
        ...
        # Changing field 'Employee.situacion'
        db.alter_column(u'home_employee', 'situacion', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Employee.nacionalidad'
        db.alter_column(u'home_employee', 'nacionalidad', self.gf('django.db.models.fields.CharField')(max_length=50))
    ...
    models = {
        ...
        u'home.employee': {
            ...
            'address2': ('django.db.models.fields.CharField', [], {'max_length': '180'}),
            ...
            'feching': ('django.db.models.fields.DateField', [], {'null': 'True'}),
            'firstname': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'lastname': ('django.db.models.fields.CharField', [], {'max_length': '150'}),
            'nacionalidad': ('django.db.models.fields.CharField', [], {'default': "'Peru'", 'max_length': '50', 'null': 'True', 'blank': 'True'}),
