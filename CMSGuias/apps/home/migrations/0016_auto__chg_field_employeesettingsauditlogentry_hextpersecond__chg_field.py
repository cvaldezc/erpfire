...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmployeeSettingsAuditLogEntry.hextpersecond'
        db.alter_column(u'home_employeesettingsauditlogentry', 'hextpersecond', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'EmployeeSettingsAuditLogEntry.hextperfirst'
        db.alter_column(u'home_employeesettingsauditlogentry', 'hextperfirst', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'EmployeeSettings.hextpersecond'
        db.alter_column(u'home_employeesettings', 'hextpersecond', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

        # Changing field 'EmployeeSettings.hextperfirst'
        db.alter_column(u'home_employeesettings', 'hextperfirst', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'EmployeeSettingsAuditLogEntry.hextpersecond'
        db.alter_column(u'home_employeesettingsauditlogentry', 'hextpersecond', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

        # Changing field 'EmployeeSettingsAuditLogEntry.hextperfirst'
        db.alter_column(u'home_employeesettingsauditlogentry', 'hextperfirst', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

        # Changing field 'EmployeeSettings.hextpersecond'
        db.alter_column(u'home_employeesettings', 'hextpersecond', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))

        # Changing field 'EmployeeSettings.hextperfirst'
        db.alter_column(u'home_employeesettings', 'hextperfirst', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=2))
