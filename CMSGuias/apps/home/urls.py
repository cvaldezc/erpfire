...
customers_urls = patterns(
    '',
    url(r'^list/$', CustomersList.as_view(),
        name='customers_list'),
    url(r'^new/$', CustomersCreate.as_view(),
        name='customers_new'),
    url(r'^edit/(?P<pk>\w+)/$',
        CustomersUpdate.as_view(), name='customers_edit'),
    url(r'^delete/(?P<pk>\w+)/$',
        CustomersDelete.as_view(), name='customers_del'),
)
# Country
country_urls = patterns(
    '',
    url(r'^list/$', CountryList.as_view(),
        name='country_list'),
    url(r'^new/$', CountryCreate.as_view(),
        name='country_new'),
    url(r'^edit/(?P<pais_id>\w+)/$',
        CountryUpdate.as_view(), name='country_edit'),
    url(r'^delete/(?P<pais_id>\w+)/$',
        CountryDelete.as_view(), name='country_del'),
)
# Departament
departament_urls = patterns(
    '',
    url(r'^list/$', DepartamentList.as_view(),
        name='departament_list'),
    url(r'^new/$', DepartamentCreate.as_view(),
        name='departament_new'),
    url(r'^edit/(?P<departamento_id>\w+)/$',
        DepartamentUpdate.as_view(), name='departament_edit'),
    url(r'^delete/(?P<departamento_id>\w+)/$',
        DepartamentDelete.as_view(), name='departament_del'),
)
# Province
province_urls = patterns(
    '',
    url(r'^list/$', ProvinceList.as_view(),
        name='province_list'),
    url(r'^new/$', ProvinceCreate.as_view(),
        name='province_new'),
    url(r'^edit/(?P<provincia_id>\w+)/$',
        ProvinceUpdate.as_view(), name='province_edit'),
    url(r'^delete/(?P<provincia_id>\w+)/$',
        ProvinceDelete.as_view(), name='province_del'),
)
# District
district_urls = patterns(
    '',
    url(r'^list/$', DistrictList.as_view(),
        name='district_list'),
    url(r'^new/$', DistrictCreate.as_view(),
        name='district_new'),
    url(r'^edit/(?P<distrito_id>\w+)/$',
        DistrictUpdate.as_view(), name='district_edit'),
    url(r'^delete/(?P<distrito_id>\w+)/$',
        DistrictDelete.as_view(), name='district_del'),
)
# Brand
brand_urls = patterns(
    '',
...
model_urls = patterns(
    ...
    url(r'^edit/(?P<model_id>\w+)/$',
        ModelUpdate.as_view(), name='model_edit'),
    url(r'^delete/(?P<model_id>\w+)/$',
        ModelDelete.as_view(), name='model_del'),
)
# Type Group Materials
tgroup_urls = patterns(
    '',
    url(r'^list/$', TGroupList.as_view(),
        name='tgroup_list'),
    url(r'^new/$', TGroupCreate.as_view(),
        name='tgroup_new'),
    url(r'^edit/(?P<tgroup_id>\w+)/$',
        TGroupUpdate.as_view(), name='tgroup_edit'),
    url(r'^delete/(?P<tgroup_id>\w+)/$',
        TGroupDelete.as_view(), name='tgroup_del'),
)
# Type Group Materials
gmaterials_urls = patterns(
    '',
    url(r'^list/$', GMaterialsList.as_view(),
        name='gmaterials_list'),
    url(r'^new/$', GMaterialsCreate.as_view(),
        name='gmaterials_new'),
    url(r'^edit/(?P<mgroup_id>\w+)/$',
        GMaterialsUpdate.as_view(), name='gmaterials_edit'),
    url(r'^edit/save/(?P<mgroup_id>\w+)/$',
        GMaterialsUpdateSave.as_view(), name='gmaterials_edit_save'),
    url(r'^delete/(?P<mgroup_id>\w+)/$',
        GMaterialsDelete.as_view(), name='gmaterials_del'),
    url(r'^details/(?P<mgroup>\w+)/$',
        DetailsGMaterials.as_view(), name='gmaterials_details'),
)
# Crud Materials
