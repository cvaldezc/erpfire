...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompraAuditLogEntry'
        db.create_table(u'logistica_compraauditlogentry', (
            ('compra_id', self.gf('django.db.models.fields.CharField')(max_length=10, db_index=True)),
            ...
            ('quotation', self.gf('django.db.models.fields.CharField')(max_length=25, null=True, blank=True)),
            ...
            ('sigv', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('observation', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('paid', self.gf('django.db.models.fields.CharField')(default='0', max_length=1, blank=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_compra_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'logistica', ['CompraAuditLogEntry'])

        # Adding model 'DetCompraAuditLogEntry'
        db.create_table(u'logistica_detcompraauditlogentry', (
            ...
            ('unit', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Unidade'], null=True, blank=True)),
            ...
            ('perception', self.gf('django.db.models.fields.FloatField')(default=0, blank=True)),
            ('convertto', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=6, decimal_places=2)),
            ('observation', self.gf('django.db.models.fields.TextField')(default='', blank=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_detcompra_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'logistica', ['DetCompraAuditLogEntry'])


    def backwards(self, orm):
        # Deleting model 'CompraAuditLogEntry'
        db.delete_table(u'logistica_compraauditlogentry')

        # Deleting model 'DetCompraAuditLogEntry'
        db.delete_table(u'logistica_detcompraauditlogentry')
    ...
    models = {
        ...
        u'logistica.serviceorder': {
            ...
            'tag': ('django.db.models.fields.CharField', [], {'default': "'#TODO'", 'max_length': '80'}),
