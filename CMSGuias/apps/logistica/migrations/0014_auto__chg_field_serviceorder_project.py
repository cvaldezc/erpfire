...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ServiceOrder.project'
        db.alter_column(u'logistica_serviceorder', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Proyecto'], null=True))

    def backwards(self, orm):

        # Changing field 'ServiceOrder.project'
        db.alter_column(u'logistica_serviceorder', 'project_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['ventas.Proyecto']))
