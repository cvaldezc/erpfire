...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DetCompra.convertto'
        db.add_column(u'logistica_detcompra', 'convertto',
                      self.gf('django.db.models.fields.DecimalField')(default='1', max_digits=6, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DetCompra.convertto'
        db.delete_column(u'logistica_detcompra', 'convertto')
