...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming column for 'ServiceOrder.quotation' to match new field type.
        db.rename_column(u'logistica_serviceorder', 'quotation_id', 'quotation')
        # Changing field 'ServiceOrder.quotation'
        db.alter_column(u'logistica_serviceorder', 'quotation', self.gf('django.db.models.fields.CharField')(max_length=12, null=True))
        # Removing index on 'ServiceOrder', fields ['quotation']
        db.delete_index(u'logistica_serviceorder', ['quotation_id'])


    def backwards(self, orm):
        # Adding index on 'ServiceOrder', fields ['quotation']
        db.create_index(u'logistica_serviceorder', ['quotation_id'])


        # Renaming column for 'ServiceOrder.quotation' to match new field type.
        db.rename_column(u'logistica_serviceorder', 'quotation', 'quotation_id')
        # Changing field 'ServiceOrder.quotation'
        db.alter_column(u'logistica_serviceorder', 'quotation_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logistica.Cotizacion'], null=True))
