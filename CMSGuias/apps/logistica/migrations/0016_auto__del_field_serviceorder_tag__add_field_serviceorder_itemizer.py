...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ServiceOrder.tag'
        db.delete_column(u'logistica_serviceorder', 'tag')

        # Adding field 'ServiceOrder.itemizer'
        db.add_column(u'logistica_serviceorder', 'itemizer',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='itemizerasproject', null=True, to=orm['ventas.ProjectItemizer']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ServiceOrder.tag'
        db.add_column(u'logistica_serviceorder', 'tag',
                      self.gf('django.db.models.fields.CharField')(default='#TODO', max_length=80),
                      keep_default=False)

        # Deleting field 'ServiceOrder.itemizer'
        db.delete_column(u'logistica_serviceorder', 'itemizer_id')
    ...
    models = {
        ...
        u'logistica.serviceorder': {
            ...
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'itemizer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'itemizerasproject'", 'null': 'True', 'to': u"orm['ventas.ProjectItemizer']"}),
