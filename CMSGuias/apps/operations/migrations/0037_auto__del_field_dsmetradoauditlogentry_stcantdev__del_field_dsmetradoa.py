...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DSMetradoAuditLogEntry.stcantdev'
        db.delete_column(u'operations_dsmetradoauditlogentry', 'stcantdev')

        # Deleting field 'DSMetradoAuditLogEntry.cantdev'
        db.delete_column(u'operations_dsmetradoauditlogentry', 'cantdev')

        # Deleting field 'Nipple.stcantenvnip'
        db.delete_column(u'operations_nipple', 'stcantenvnip')

        # Deleting field 'Nipple.cantenvnip'
        db.delete_column(u'operations_nipple', 'cantenvnip')

        # Deleting field 'DSMetrado.stcantdev'
        db.delete_column(u'operations_dsmetrado', 'stcantdev')

        # Deleting field 'DSMetrado.cantdev'
        db.delete_column(u'operations_dsmetrado', 'cantdev')
    ...
    models = {
        ...
        u'operations.dsmetradotemp': {
            ...
            'qsold': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
