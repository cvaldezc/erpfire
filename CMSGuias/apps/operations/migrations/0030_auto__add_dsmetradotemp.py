...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'DSMetradoTemp'
        db.create_table(u'operations_dsmetradotemp', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('dsector', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['operations.DSector'])),
            ('materials', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale'])),
            ('brand', self.gf('django.db.models.fields.related.ForeignKey')(related_name='brand_DSMtemp', to=orm['home.Brand'])),
            ('model', self.gf('django.db.models.fields.related.ForeignKey')(related_name='model_DSMtemp', to=orm['home.Model'])),
            ('missingsend', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=8)),
            ('quantity', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=5, decimal_places=3)),
            ...
            ('sysmbol', self.gf('django.db.models.fields.CharField')(default='+', max_length=1)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'operations', ['DSMetradoTemp'])


    def backwards(self, orm):
        # Deleting model 'DSMetradoTemp'
        db.delete_table(u'operations_dsmetradotemp')
    ...
    models = {
        ...
        u'operations.dsmetradotemp': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'sysmbol': ('django.db.models.fields.CharField', [], {'default': "'+'", 'max_length': '1'}),
