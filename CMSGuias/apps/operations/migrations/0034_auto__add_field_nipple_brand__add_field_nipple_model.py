...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Nipple.brand'
        db.add_column(u'operations_nipple', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='BR000', related_name='brandtonipple', to=orm['home.Brand']),
                      keep_default=False)

        # Adding field 'Nipple.model'
        db.add_column(u'operations_nipple', 'model',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='MO000', related_name='modeltonipple', to=orm['home.Model']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Nipple.brand'
        db.delete_column(u'operations_nipple', 'brand_id')

        # Deleting field 'Nipple.model'
        db.delete_column(u'operations_nipple', 'model_id')
