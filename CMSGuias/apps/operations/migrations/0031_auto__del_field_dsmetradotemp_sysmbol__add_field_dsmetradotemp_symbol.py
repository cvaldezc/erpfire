...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DSMetradoTemp.sysmbol'
        db.delete_column(u'operations_dsmetradotemp', 'sysmbol')

        # Adding field 'DSMetradoTemp.symbol'
        db.add_column(u'operations_dsmetradotemp', 'symbol',
                      self.gf('django.db.models.fields.CharField')(default='+', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'DSMetradoTemp.sysmbol'
        db.add_column(u'operations_dsmetradotemp', 'sysmbol',
                      self.gf('django.db.models.fields.CharField')(default='+', max_length=1),
                      keep_default=False)

        # Deleting field 'DSMetradoTemp.symbol'
        db.delete_column(u'operations_dsmetradotemp', 'symbol')
    ...
    models = {
        ...
        u'operations.dsmetradotemp': {
            ...
            'ppurchase': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '3'}),
            'psales': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '8', 'decimal_places': '3'}),
            'quantity': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '5', 'decimal_places': '3'}),
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
