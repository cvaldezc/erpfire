...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DSMetradoTemp.qsold'
        db.add_column(u'operations_dsmetradotemp', 'qsold',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DSMetradoTemp.qsold'
        db.delete_column(u'operations_dsmetradotemp', 'qsold')
