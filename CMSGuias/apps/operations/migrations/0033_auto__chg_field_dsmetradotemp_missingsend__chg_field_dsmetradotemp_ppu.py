...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DSMetradoTemp.missingsend'
        db.alter_column(u'operations_dsmetradotemp', 'missingsend', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Changing field 'DSMetradoTemp.ppurchase'
        db.alter_column(u'operations_dsmetradotemp', 'ppurchase', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Changing field 'DSMetradoTemp.psales'
        db.alter_column(u'operations_dsmetradotemp', 'psales', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

        # Changing field 'DSMetradoTemp.quantity'
        db.alter_column(u'operations_dsmetradotemp', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=12, decimal_places=3))

    def backwards(self, orm):

        # Changing field 'DSMetradoTemp.missingsend'
        db.alter_column(u'operations_dsmetradotemp', 'missingsend', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=8))

        # Changing field 'DSMetradoTemp.ppurchase'
        db.alter_column(u'operations_dsmetradotemp', 'ppurchase', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=3))

        # Changing field 'DSMetradoTemp.psales'
        db.alter_column(u'operations_dsmetradotemp', 'psales', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=3))

        # Changing field 'DSMetradoTemp.quantity'
        db.alter_column(u'operations_dsmetradotemp', 'quantity', self.gf('django.db.models.fields.DecimalField')(max_digits=11, decimal_places=3))
    ...
    models = {
        ...
        u'operations.dsmetradotemp': {
            'Meta': {'object_name': 'DSMetradoTemp'},
            'brand': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'brand_DSMtemp'", 'to': u"orm['home.Brand']"}),
            'dsector': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['operations.DSector']"}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'materials': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Materiale']"}),
            'missingsend': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'model': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'model_DSMtemp'", 'to': u"orm['home.Model']"}),
            'ppurchase': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'psales': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'quantity': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
