...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CloseProjectAuditLogEntry.datestorage'
        db.alter_column(u'ventas_closeprojectauditlogentry', 'datestorage', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'CloseProject.datestorage'
        db.alter_column(u'ventas_closeproject', 'datestorage', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'CloseProjectAuditLogEntry.datestorage'
        db.alter_column(u'ventas_closeprojectauditlogentry', 'datestorage', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'CloseProject.datestorage'
        db.alter_column(u'ventas_closeproject', 'datestorage', self.gf('django.db.models.fields.DateTimeField')(default=''))
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'D70THJ'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'KYHRK1'", 'max_length': '6'})
        },
        u'ventas.sectore': {
