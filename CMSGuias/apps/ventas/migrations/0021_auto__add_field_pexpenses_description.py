...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PExpenses.description'
        db.add_column(u'ventas_pexpenses', 'description',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PExpenses.description'
        db.delete_column(u'ventas_pexpenses', 'description')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'RFFH57'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'7JLXRG'", 'max_length': '6'})
        },
        u'ventas.sectore': {
