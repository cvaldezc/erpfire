...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PExpenses.register'
        db.add_column(u'ventas_pexpenses', 'register',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2017, 10, 12, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PExpenses.register'
        db.delete_column(u'ventas_pexpenses', 'register')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'CXRXPI'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'PLPBHY'", 'max_length': '6'})
        },
        u'ventas.sectore': {
