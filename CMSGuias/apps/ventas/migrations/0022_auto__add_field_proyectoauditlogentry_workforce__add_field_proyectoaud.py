...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProyectoAuditLogEntry.workforce'
        db.add_column(u'ventas_proyectoauditlogentry', 'workforce',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3),
                      keep_default=False)

        # Adding field 'ProyectoAuditLogEntry.workforceused'
        db.add_column(u'ventas_proyectoauditlogentry', 'workforceused',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3),
                      keep_default=False)

        # Adding field 'Proyecto.workforce'
        db.add_column(u'ventas_proyecto', 'workforce',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3),
                      keep_default=False)

        # Adding field 'Proyecto.workforceused'
        db.add_column(u'ventas_proyecto', 'workforceused',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProyectoAuditLogEntry.workforce'
        db.delete_column(u'ventas_proyectoauditlogentry', 'workforce')

        # Deleting field 'ProyectoAuditLogEntry.workforceused'
        db.delete_column(u'ventas_proyectoauditlogentry', 'workforceused')

        # Deleting field 'Proyecto.workforce'
        db.delete_column(u'ventas_proyecto', 'workforce')

        # Deleting field 'Proyecto.workforceused'
        db.delete_column(u'ventas_proyecto', 'workforceused')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'4G0PFZ'", 'max_length': '6'})
        },
        ...
        u'ventas.pexpenses': {
            'Meta': {'ordering': "[u'project', u'-register']", 'object_name': 'PExpenses'},
            'amount': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'currency': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'expensescurrency'", 'to': u"orm['home.Moneda']"}),
            'description': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'itemizer': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'projectitemizer'", 'to': u"orm['ventas.ProjectItemizer']"}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'projectexpenses'", 'to': u"orm['ventas.Proyecto']"}),
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
        ...
        u'ventas.projectitemizerauditlogentry': {
            'Meta': {'ordering': "(u'-action_date',)", 'object_name': 'ProjectItemizerAuditLogEntry'},
            u'action_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'action_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'action_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'action_user': ('audit_log.models.fields.LastUserField', [], {'related_name': "u'_projectitemizer_audit_log_entry'", 'to': u"orm['auth.User']"}),
            'itemizer_id': ('django.db.models.fields.CharField', [], {'default': "u'PRAA000IT000'", 'max_length': '12', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'project': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'_auditlog_projectasitemizer'", 'to': u"orm['ventas.Proyecto']"}),
            'purchase': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'sales': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'tag': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        ...
        u'ventas.proyecto': {
            ...
            'workforce': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'}),
            'workforceused': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '12', 'decimal_places': '3'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'PJIH1B'", 'max_length': '6'})
        },
        u'ventas.sectore': {
