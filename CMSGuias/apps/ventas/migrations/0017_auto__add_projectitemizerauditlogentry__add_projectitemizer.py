...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ProjectItemizerAuditLogEntry'
        db.create_table(u'ventas_projectitemizerauditlogentry', (
            ('itemizer', self.gf('django.db.models.fields.CharField')(default=u'PRAA000IT000', max_length=12, db_index=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_projectasitemizer', to=orm['ventas.Proyecto'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('purchase', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
            ('sales', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
            ('tag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_projectitemizer_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'ventas', ['ProjectItemizerAuditLogEntry'])

        # Adding model 'ProjectItemizer'
        db.create_table(u'ventas_projectitemizer', (
            ('itemizer', self.gf('django.db.models.fields.CharField')(default=u'PRAA000IT000', max_length=12, primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'projectasitemizer', to=orm['ventas.Proyecto'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('purchase', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
            ('sales', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
        ...
        db.send_create_signal(u'ventas', ['ProjectItemizer'])


    def backwards(self, orm):
        # Deleting model 'ProjectItemizerAuditLogEntry'
        db.delete_table(u'ventas_projectitemizerauditlogentry')

        # Deleting model 'ProjectItemizer'
        db.delete_table(u'ventas_projectitemizer')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'PIBLL3'", 'max_length': '6'})
        },
        ...
        u'ventas.projectitemizer': {
            ...
            'itemizer': ('django.db.models.fields.CharField', [], {'default': "u'PRAA000IT000'", 'max_length': '12', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'ventas.projectitemizerauditlogentry': {
            ...
            'itemizer': ('django.db.models.fields.CharField', [], {'default': "u'PRAA000IT000'", 'max_length': '12', 'db_index': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'CHZK68'", 'max_length': '6'})
        },
        u'ventas.sectore': {
