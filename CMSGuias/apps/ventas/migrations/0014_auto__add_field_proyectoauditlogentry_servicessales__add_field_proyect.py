...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProyectoAuditLogEntry.servicessales'
        db.add_column(u'ventas_proyectoauditlogentry', 'servicessales',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'ProyectoAuditLogEntry.handworkpurchase'
        db.add_column(u'ventas_proyectoauditlogentry', 'handworkpurchase',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'ProyectoAuditLogEntry.handworksales'
        db.add_column(u'ventas_proyectoauditlogentry', 'handworksales',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'ProyectoAuditLogEntry.starthour'
        db.add_column(u'ventas_proyectoauditlogentry', 'starthour',
                      self.gf('django.db.models.fields.TimeField')(default=u'07:30:00', blank=True),
                      keep_default=False)

        # Adding field 'Proyecto.servicessales'
        db.add_column(u'ventas_proyecto', 'servicessales',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Proyecto.handworkpurchase'
        db.add_column(u'ventas_proyecto', 'handworkpurchase',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Proyecto.handworksales'
        db.add_column(u'ventas_proyecto', 'handworksales',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=2),
                      keep_default=False)

        # Adding field 'Proyecto.starthour'
        db.add_column(u'ventas_proyecto', 'starthour',
                      self.gf('django.db.models.fields.TimeField')(default=u'07:30:00', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProyectoAuditLogEntry.servicessales'
        db.delete_column(u'ventas_proyectoauditlogentry', 'servicessales')

        # Deleting field 'ProyectoAuditLogEntry.handworkpurchase'
        db.delete_column(u'ventas_proyectoauditlogentry', 'handworkpurchase')

        # Deleting field 'ProyectoAuditLogEntry.handworksales'
        db.delete_column(u'ventas_proyectoauditlogentry', 'handworksales')

        # Deleting field 'ProyectoAuditLogEntry.starthour'
        db.delete_column(u'ventas_proyectoauditlogentry', 'starthour')

        # Deleting field 'Proyecto.servicessales'
        db.delete_column(u'ventas_proyecto', 'servicessales')

        # Deleting field 'Proyecto.handworkpurchase'
        db.delete_column(u'ventas_proyecto', 'handworkpurchase')

        # Deleting field 'Proyecto.handworksales'
        db.delete_column(u'ventas_proyecto', 'handworksales')

        # Deleting field 'Proyecto.starthour'
        db.delete_column(u'ventas_proyecto', 'starthour')
    ...
    models = {
        ...
        u'ventas.closeproject': {
            ...
            'datestorage': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'ZE7ZPA'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'H033CB'", 'max_length': '6'})
        },
        u'ventas.sectore': {
