...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProyectoAuditLogEntry.shxsaturday'
        db.add_column(u'ventas_proyectoauditlogentry', 'shxsaturday',
                      self.gf('django.db.models.fields.TimeField')(default=u'15:00:00', blank=True),
                      keep_default=False)

        # Adding field 'ProyectoAuditLogEntry.shxsaturdayt'
        db.add_column(u'ventas_proyectoauditlogentry', 'shxsaturdayt',
                      self.gf('django.db.models.fields.TimeField')(default=u'17:000:00', blank=True),
                      keep_default=False)

        # Adding field 'Proyecto.shxsaturday'
        db.add_column(u'ventas_proyecto', 'shxsaturday',
                      self.gf('django.db.models.fields.TimeField')(default=u'15:00:00', blank=True),
                      keep_default=False)

        # Adding field 'Proyecto.shxsaturdayt'
        db.add_column(u'ventas_proyecto', 'shxsaturdayt',
                      self.gf('django.db.models.fields.TimeField')(default=u'17:000:00', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProyectoAuditLogEntry.shxsaturday'
        db.delete_column(u'ventas_proyectoauditlogentry', 'shxsaturday')

        # Deleting field 'ProyectoAuditLogEntry.shxsaturdayt'
        db.delete_column(u'ventas_proyectoauditlogentry', 'shxsaturdayt')

        # Deleting field 'Proyecto.shxsaturday'
        db.delete_column(u'ventas_proyecto', 'shxsaturday')

        # Deleting field 'Proyecto.shxsaturdayt'
        db.delete_column(u'ventas_proyecto', 'shxsaturdayt')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'C8RGBT'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'7CZYFR'", 'max_length': '6'})
        },
        u'ventas.sectore': {
