...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProyectoAuditLogEntry.outsaturday'
        db.add_column(u'ventas_proyectoauditlogentry', 'outsaturday',
                      self.gf('django.db.models.fields.TimeField')(default=u'13:30:00', blank=True),
                      keep_default=False)

        # Adding field 'Proyecto.outsaturday'
        db.add_column(u'ventas_proyecto', 'outsaturday',
                      self.gf('django.db.models.fields.TimeField')(default=u'13:30:00', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProyectoAuditLogEntry.outsaturday'
        db.delete_column(u'ventas_proyectoauditlogentry', 'outsaturday')

        # Deleting field 'Proyecto.outsaturday'
        db.delete_column(u'ventas_proyecto', 'outsaturday')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'HJCGHA'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'HRT35X'", 'max_length': '6'})
        },
        u'ventas.sectore': {
