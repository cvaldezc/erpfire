...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PExpenses'
        db.create_table(u'ventas_pexpenses', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'projectexpenses', to=orm['ventas.Proyecto'])),
            ('itemizer', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'projectitemizer', to=orm['ventas.ProjectItemizer'])),
            ('currency', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'expensescurrency', to=orm['home.Moneda'])),
            ('amount', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=12, decimal_places=3)),
        ))
        db.send_create_signal(u'ventas', ['PExpenses'])


    def backwards(self, orm):
        # Deleting model 'PExpenses'
        db.delete_table(u'ventas_pexpenses')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'R00ETF'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'5ZZ6HT'", 'max_length': '6'})
        },
        u'ventas.sectore': {
