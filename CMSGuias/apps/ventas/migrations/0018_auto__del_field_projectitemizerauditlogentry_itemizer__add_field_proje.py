...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ProjectItemizerAuditLogEntry.itemizer'
        db.delete_column(u'ventas_projectitemizerauditlogentry', 'itemizer')

        # Adding field 'ProjectItemizerAuditLogEntry.itemizer_id'
        db.add_column(u'ventas_projectitemizerauditlogentry', 'itemizer_id',
                      self.gf('django.db.models.fields.CharField')(default=u'PRAA000IT000', max_length=12, db_index=True),
                      keep_default=False)

        # Deleting field 'ProjectItemizer.itemizer'
        db.delete_column(u'ventas_projectitemizer', 'itemizer')

        # Adding field 'ProjectItemizer.itemizer_id'
        db.add_column(u'ventas_projectitemizer', 'itemizer_id',
                      self.gf('django.db.models.fields.CharField')(default=u'PRAA000IT000', max_length=12, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ProjectItemizerAuditLogEntry.itemizer'
        db.add_column(u'ventas_projectitemizerauditlogentry', 'itemizer',
                      self.gf('django.db.models.fields.CharField')(default=u'PRAA000IT000', max_length=12, db_index=True),
                      keep_default=False)

        # Deleting field 'ProjectItemizerAuditLogEntry.itemizer_id'
        db.delete_column(u'ventas_projectitemizerauditlogentry', 'itemizer_id')

        # Adding field 'ProjectItemizer.itemizer'
        db.add_column(u'ventas_projectitemizer', 'itemizer',
                      self.gf('django.db.models.fields.CharField')(default=u'PRAA000IT000', max_length=12, primary_key=True),
                      keep_default=False)

        # Deleting field 'ProjectItemizer.itemizer_id'
        db.delete_column(u'ventas_projectitemizer', 'itemizer_id')
    ...
    models = {
        ...
        u'ventas.historymetproject': {
            ...
            'token': ('django.db.models.fields.CharField', [], {'default': "'05KHE5'", 'max_length': '6'})
        },
        ...
        u'ventas.restorestorage': {
            ...
            'subproyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Subproyecto']", 'null': 'True', 'blank': 'True'}),
            'tag': ('django.db.models.fields.CharField', [], {'default': "u'0'", 'max_length': '1'}),
            'token': ('django.db.models.fields.CharField', [], {'default': "'2TLZ5T'", 'max_length': '6'})
        },
        u'ventas.sectore': {
