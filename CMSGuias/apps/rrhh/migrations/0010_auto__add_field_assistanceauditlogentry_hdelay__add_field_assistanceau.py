...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AssistanceAuditLogEntry.flag'
        db.add_column(u'rrhh_assistanceauditlogentry', 'flag',
        ...
        # Adding field 'Assistance.flag'
        db.add_column(u'rrhh_assistance', 'flag',
                      self.gf('django.db.models.fields.CharField')(default='A', max_length=1),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'AssistanceAuditLogEntry.flag'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'flag')

        # Deleting field 'Assistance.hdelay'
        db.delete_column(u'rrhh_assistance', 'hdelay')

        # Deleting field 'Assistance.flag'
        db.delete_column(u'rrhh_assistance', 'flag')
