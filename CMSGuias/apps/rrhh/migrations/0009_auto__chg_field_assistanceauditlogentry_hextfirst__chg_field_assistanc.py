...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AssistanceAuditLogEntry.hextfirst'
        db.alter_column(u'rrhh_assistanceauditlogentry', 'hextfirst', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'AssistanceAuditLogEntry.hwork'
        db.alter_column(u'rrhh_assistanceauditlogentry', 'hwork', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'AssistanceAuditLogEntry.hextsecond'
        db.alter_column(u'rrhh_assistanceauditlogentry', 'hextsecond', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Assistance.hextfirst'
        db.alter_column(u'rrhh_assistance', 'hextfirst', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Assistance.hwork'
        db.alter_column(u'rrhh_assistance', 'hwork', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'Assistance.hextsecond'
        db.alter_column(u'rrhh_assistance', 'hextsecond', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

    def backwards(self, orm):

        # Changing field 'AssistanceAuditLogEntry.hextfirst'
        db.alter_column(u'rrhh_assistanceauditlogentry', 'hextfirst', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))

        # Changing field 'AssistanceAuditLogEntry.hwork'
        db.alter_column(u'rrhh_assistanceauditlogentry', 'hwork', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=3, decimal_places=1))

        # Changing field 'AssistanceAuditLogEntry.hextsecond'
        db.alter_column(u'rrhh_assistanceauditlogentry', 'hextsecond', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))

        # Changing field 'Assistance.hextfirst'
        db.alter_column(u'rrhh_assistance', 'hextfirst', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))

        # Changing field 'Assistance.hwork'
        db.alter_column(u'rrhh_assistance', 'hwork', self.gf('django.db.models.fields.DecimalField')(default=None, max_digits=3, decimal_places=1))

        # Changing field 'Assistance.hextsecond'
        db.alter_column(u'rrhh_assistance', 'hextsecond', self.gf('django.db.models.fields.DecimalField')(max_digits=3, decimal_places=1))
    ...
    models = {
        ...
        u'rrhh.assistance': {
            ...
            'hextfirst': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '3', 'decimal_places': '1'}),
            'hextsecond': ('django.db.models.fields.DecimalField', [], {'default': '0', 'null': 'True', 'max_digits': '3', 'decimal_places': '1'}),
