...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssistanceAuditLogEntry.userregister'
        db.add_column(u'rrhh_assistanceauditlogentry', 'userregister',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'_auditlog_EmployeeRegister', to=orm['home.Employee']),
                      keep_default=False)

        # Adding field 'Assistance.userregister'
        db.add_column(u'rrhh_assistance', 'userregister',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='EmployeeRegister', to=orm['home.Employee']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssistanceAuditLogEntry.userregister'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'userregister_id')

        # Deleting field 'Assistance.userregister'
        db.delete_column(u'rrhh_assistance', 'userregister_id')
