...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Induccion.stat'
        db.add_column(u'rrhh_induccion', 'stat',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2),
                      keep_default=False)

        # Adding field 'TipoInstitucionAuditLogEntry.estsuperior'
        db.add_column(u'rrhh_tipoinstitucionauditlogentry', 'estsuperior',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2),
                      keep_default=False)

        # Adding field 'TipoInstitucion.estsuperior'
        db.add_column(u'rrhh_tipoinstitucion', 'estsuperior',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2),
                      keep_default=False)

        # Adding field 'InduccionAuditLogEntry.stat'
        db.add_column(u'rrhh_induccionauditlogentry', 'stat',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Induccion.stat'
        db.delete_column(u'rrhh_induccion', 'stat')

        # Deleting field 'TipoInstitucionAuditLogEntry.estsuperior'
        db.delete_column(u'rrhh_tipoinstitucionauditlogentry', 'estsuperior')

        # Deleting field 'TipoInstitucion.estsuperior'
        db.delete_column(u'rrhh_tipoinstitucion', 'estsuperior')

        # Deleting field 'InduccionAuditLogEntry.stat'
        db.delete_column(u'rrhh_induccionauditlogentry', 'stat')
    ...
    models = {
        ...
        u'rrhh.cuentaemple': {
            ...
            'setfamily': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'rrhh.induccion': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'registro': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'stat': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2'})
        },
        ...
        u'rrhh.tipoinstitucion': {
            ...
            'estsuperior': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '2'}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        u'rrhh.tipopago': {
            ...
            'value': ('django.db.models.fields.SmallIntegerField', [], {'default': '7'})
        },
