...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BalanceAssistance.hdelay'
        db.alter_column(u'rrhh_balanceassistance', 'hdelay', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))

        # Changing field 'BalanceAssistance.hextfirst'
        db.alter_column(u'rrhh_balanceassistance', 'hextfirst', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))

        # Changing field 'BalanceAssistance.hwork'
        db.alter_column(u'rrhh_balanceassistance', 'hwork', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))

        # Changing field 'BalanceAssistance.hextsecond'
        db.alter_column(u'rrhh_balanceassistance', 'hextsecond', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'BalanceAssistance.hdelay'
        db.alter_column(u'rrhh_balanceassistance', 'hdelay', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'BalanceAssistance.hextfirst'
        db.alter_column(u'rrhh_balanceassistance', 'hextfirst', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'BalanceAssistance.hwork'
        db.alter_column(u'rrhh_balanceassistance', 'hwork', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))

        # Changing field 'BalanceAssistance.hextsecond'
        db.alter_column(u'rrhh_balanceassistance', 'hextsecond', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1))
