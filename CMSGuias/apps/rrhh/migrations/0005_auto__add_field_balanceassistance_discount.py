...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BalanceAssistance.discount'
        db.add_column(u'rrhh_balanceassistance', 'discount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=8, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BalanceAssistance.discount'
        db.delete_column(u'rrhh_balanceassistance', 'discount')
