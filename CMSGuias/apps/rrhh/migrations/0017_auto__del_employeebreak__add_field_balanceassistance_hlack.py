...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BalanceAssistance.hlack'
        db.add_column(u'rrhh_balanceassistance', 'hlack',
                      self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=4, decimal_places=2),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'rrhh_employeebreak', (
            ...
            ('interval', self.gf('django.db.models.fields.CharField')(max_length=4, primary_key=True)),
        ))
        db.send_create_signal(u'rrhh', ['EmployeeBreak'])

        # Deleting field 'BalanceAssistance.hlack'
        db.delete_column(u'rrhh_balanceassistance', 'hlack')
