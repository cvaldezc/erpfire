...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssistanceAuditLogEntry.status'
        db.add_column(u'rrhh_assistanceauditlogentry', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_breakforemployee', null=True, to=orm['rrhh.EmployeeBreak']),
                      keep_default=False)

        # Adding field 'Assistance.status'
        db.add_column(u'rrhh_assistance', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='breakforemployee', null=True, to=orm['rrhh.EmployeeBreak']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssistanceAuditLogEntry.status'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'status_id')

        # Deleting field 'Assistance.status'
        db.delete_column(u'rrhh_assistance', 'status_id')
    ...
    models = {
        ...
        u'rrhh.assistance': {
            ...
            'status': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'breakforemployee'", 'null': 'True', 'to': u"orm['rrhh.EmployeeBreak']"}),
        ...
        u'rrhh.assistanceauditlogentry': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'_auditlog_breakforemployee'", 'null': 'True', 'to': u"orm['rrhh.EmployeeBreak']"}),
            'tag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
