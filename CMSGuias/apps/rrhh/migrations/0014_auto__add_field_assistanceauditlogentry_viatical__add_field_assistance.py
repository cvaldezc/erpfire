...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssistanceAuditLogEntry.viatical'
        db.add_column(u'rrhh_assistanceauditlogentry', 'viatical',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'Assistance.viatical'
        db.add_column(u'rrhh_assistance', 'viatical',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssistanceAuditLogEntry.viatical'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'viatical')

        # Deleting field 'Assistance.viatical'
        db.delete_column(u'rrhh_assistance', 'viatical')
