...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TypesEmployee'
        db.create_table(u'rrhh_typesemployee', (
            ('types_id', self.gf('django.db.models.fields.CharField')(default='TY00', max_length=4, primary_key=True)),
            ...
            ('starthour', self.gf('django.db.models.fields.TimeField')(default='08:00')),
            ('outsaturday', self.gf('django.db.models.fields.TimeField')(default='00:00:00', null=True, blank=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'rrhh', ['TypesEmployee'])

        # Adding model 'TypesEmployeeAuditLogEntry'
        db.create_table(u'rrhh_typesemployeeauditlogentry', (
            ('types_id', self.gf('django.db.models.fields.CharField')(default='TY00', max_length=4, db_index=True)),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('starthour', self.gf('django.db.models.fields.TimeField')(default='08:00')),
            ('outsaturday', self.gf('django.db.models.fields.TimeField')(default='00:00:00', null=True, blank=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_typesemployee_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'rrhh', ['TypesEmployeeAuditLogEntry'])
        ...
        db.create_table(u'rrhh_assistanceauditlogentry', (
            ...
            ('userregister', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_EmployeeRegister', to=orm['home.Employee'])),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_AssistanceEmployee', to=orm['home.Employee'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_AssistanceProject', null=True, to=orm['ventas.Proyecto'])),
            ('types', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_AssistanceTypeEmpployee', to=orm['rrhh.TypesEmployee'])),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('assistance', self.gf('django.db.models.fields.DateField')()),
            ...
            ('viatical', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2)),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(default='AS01', related_name=u'_auditlog_breakforemployee', null=True, to=orm['rrhh.EmployeeBreak'])),
            ('flag', self.gf('django.db.models.fields.CharField')(default='A', max_length=1)),
        ...
        # Adding model 'EmployeeBreak'
        db.create_table(u'rrhh_employeebreak', (
            ('status_id', self.gf('django.db.models.fields.CharField')(max_length=4, primary_key=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('payment', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'rrhh', ['EmployeeBreak'])

        # Adding model 'BalanceAssistance'
        db.create_table(u'rrhh_balanceassistance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='EmployeeasRegister', to=orm['home.Employee'])),
            ('assistance', self.gf('django.db.models.fields.DateField')()),
            ('hextfirst', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2)),
            ('hextsecond', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2)),
            ('hwork', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2)),
            ('hdelay', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2)),
            ('hlack', self.gf('django.db.models.fields.DecimalField')(default=0, null=True, max_digits=4, decimal_places=2)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'rrhh', ['BalanceAssistance'])

        # Adding model 'Assistance'
        db.create_table(u'rrhh_assistance', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('userregister', self.gf('django.db.models.fields.related.ForeignKey')(related_name='EmployeeRegister', to=orm['home.Employee'])),
            ('employee', self.gf('django.db.models.fields.related.ForeignKey')(related_name='AssistanceEmployee', to=orm['home.Employee'])),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='AssistanceProject', null=True, to=orm['ventas.Proyecto'])),
            ('types', self.gf('django.db.models.fields.related.ForeignKey')(related_name='AssistanceTypeEmpployee', to=orm['rrhh.TypesEmployee'])),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('assistance', self.gf('django.db.models.fields.DateField')()),
            ('hourin', self.gf('django.db.models.fields.TimeField')(default='00:00:00')),
            ('hourinbreak', self.gf('django.db.models.fields.TimeField')(default='00:00:00')),
            ...
            ('hourout', self.gf('django.db.models.fields.TimeField')(default='00:00:00')),
            ('viatical', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=4, decimal_places=2)),
            ('status', self.gf('django.db.models.fields.related.ForeignKey')(default='AS01', related_name='breakforemployee', null=True, to=orm['rrhh.EmployeeBreak'])),
            ('flag', self.gf('django.db.models.fields.CharField')(default='A', max_length=1)),
            ('tag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
    ...
    def backwards(self, orm):
        # Deleting model 'TypesEmployee'
        db.delete_table(u'rrhh_typesemployee')

        # Deleting model 'TypesEmployeeAuditLogEntry'
        db.delete_table(u'rrhh_typesemployeeauditlogentry')

        # Deleting model 'AssistanceAuditLogEntry'
        db.delete_table(u'rrhh_assistanceauditlogentry')

        # Deleting model 'EmployeeBreak'
        db.delete_table(u'rrhh_employeebreak')

        # Deleting model 'BalanceAssistance'
        db.delete_table(u'rrhh_balanceassistance')
