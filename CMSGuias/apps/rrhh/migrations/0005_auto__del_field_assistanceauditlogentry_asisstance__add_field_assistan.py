...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssistanceAuditLogEntry.asisstance'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'asisstance')

        # Adding field 'AssistanceAuditLogEntry.assistance'
        db.add_column(u'rrhh_assistanceauditlogentry', 'assistance',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)

        # Deleting field 'Assistance.asisstance'
        db.delete_column(u'rrhh_assistance', 'asisstance')

        # Adding field 'Assistance.assistance'
        db.add_column(u'rrhh_assistance', 'assistance',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AssistanceAuditLogEntry.asisstance'
        db.add_column(u'rrhh_assistanceauditlogentry', 'asisstance',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)

        # Deleting field 'AssistanceAuditLogEntry.assistance'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'assistance')

        # Adding field 'Assistance.asisstance'
        db.add_column(u'rrhh_assistance', 'asisstance',
                      self.gf('django.db.models.fields.DateField')(default=None),
                      keep_default=False)

        # Deleting field 'Assistance.assistance'
        db.delete_column(u'rrhh_assistance', 'assistance')
