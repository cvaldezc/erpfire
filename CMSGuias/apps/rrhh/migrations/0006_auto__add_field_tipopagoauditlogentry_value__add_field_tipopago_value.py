...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipoPagoAuditLogEntry.value'
        db.add_column(u'rrhh_tipopagoauditlogentry', 'value',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=7),
                      keep_default=False)

        # Adding field 'TipoPago.value'
        db.add_column(u'rrhh_tipopago', 'value',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=7),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipoPagoAuditLogEntry.value'
        db.delete_column(u'rrhh_tipopagoauditlogentry', 'value')

        # Deleting field 'TipoPago.value'
        db.delete_column(u'rrhh_tipopago', 'value')
