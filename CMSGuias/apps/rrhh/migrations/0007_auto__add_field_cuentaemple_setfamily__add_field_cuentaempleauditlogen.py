...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CuentaEmple.setfamily'
        db.add_column(u'rrhh_cuentaemple', 'setfamily',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CuentaEmpleAuditLogEntry.setfamily'
        db.add_column(u'rrhh_cuentaempleauditlogentry', 'setfamily',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CuentaEmple.setfamily'
        db.delete_column(u'rrhh_cuentaemple', 'setfamily')

        # Deleting field 'CuentaEmpleAuditLogEntry.setfamily'
        db.delete_column(u'rrhh_cuentaempleauditlogentry', 'setfamily')
