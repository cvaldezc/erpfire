...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        u'rrhh.asisstance': {
            'Meta': {'ordering': "['-register']", 'object_name': 'Asisstance'},
        ...
        u'rrhh.asisstanceauditlogentry': {
            'Meta': {'ordering': "(u'-action_date',)", 'object_name': 'AsisstanceAuditLogEntry'},
            ...
            u'action_user': ('audit_log.models.fields.LastUserField', [], {'related_name': "u'_asisstance_audit_log_entry'", 'to': u"orm['auth.User']"}),
            'asisstance': ('django.db.models.fields.DateField', [], {}),
