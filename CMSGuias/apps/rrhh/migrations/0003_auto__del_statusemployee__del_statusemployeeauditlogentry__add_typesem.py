...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting model 'StatusEmployee'
        db.delete_table(u'rrhh_statusemployee')

        # Deleting model 'StatusEmployeeAuditLogEntry'
        db.delete_table(u'rrhh_statusemployeeauditlogentry')

        # Adding model 'TypesEmployeeAuditLogEntry'
        db.create_table(u'rrhh_typesemployeeauditlogentry', (
            ('status_id', self.gf('django.db.models.fields.CharField')(default='SE00', max_length=4, db_index=True)),
        ...
        db.create_table(u'rrhh_typesemployee', (
            ('status_id', self.gf('django.db.models.fields.CharField')(default='SE00', max_length=4, primary_key=True)),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        ...
        # Changing field 'AssistanceAuditLogEntry.stsemp'
        db.alter_column(u'rrhh_assistanceauditlogentry', 'stsemp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rrhh.TypesEmployee']))

        # Changing field 'Assistance.stsemp'
        db.alter_column(u'rrhh_assistance', 'stsemp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rrhh.TypesEmployee']))

    def backwards(self, orm):
        # Adding model 'StatusEmployee'
        db.create_table(u'rrhh_statusemployee', (
            ('status_id', self.gf('django.db.models.fields.CharField')(default='SE00', max_length=4, primary_key=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'rrhh', ['StatusEmployee'])

        # Adding model 'StatusEmployeeAuditLogEntry'
        db.create_table(u'rrhh_statusemployeeauditlogentry', (
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=60)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
            ('status_id', self.gf('django.db.models.fields.CharField')(default='SE00', max_length=4, db_index=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_statusemployee_audit_log_entry', to=orm['auth.User'])),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'rrhh', ['StatusEmployeeAuditLogEntry'])
        ...
        # Changing field 'AssistanceAuditLogEntry.stsemp'
        db.alter_column(u'rrhh_assistanceauditlogentry', 'stsemp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rrhh.StatusEmployee']))

        # Changing field 'Assistance.stsemp'
        db.alter_column(u'rrhh_assistance', 'stsemp_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['rrhh.StatusEmployee']))
    ...
    models = {
        ...
        u'rrhh.assistance': {
            ...
            'stsemp': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'AssistanceTypeEmpployee'", 'to': u"orm['rrhh.TypesEmployee']"}),
        ...
        u'rrhh.assistanceauditlogentry': {
            ...
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'stsemp': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'_auditlog_AssistanceTypeEmpployee'", 'to': u"orm['rrhh.TypesEmployee']"}),
            'tag': ('django.db.models.fields.BooleanField', [], {'default': 'True'})
        },
