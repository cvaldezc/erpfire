...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TypesEmployee.outsaturday'
        db.add_column(u'rrhh_typesemployee', 'outsaturday',
                      self.gf('django.db.models.fields.TimeField')(default='00:00:00', null=True, blank=True),
                      keep_default=False)

        # Adding field 'TypesEmployeeAuditLogEntry.outsaturday'
        db.add_column(u'rrhh_typesemployeeauditlogentry', 'outsaturday',
                      self.gf('django.db.models.fields.TimeField')(default='00:00:00', null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TypesEmployee.outsaturday'
        db.delete_column(u'rrhh_typesemployee', 'outsaturday')

        # Deleting field 'TypesEmployeeAuditLogEntry.outsaturday'
        db.delete_column(u'rrhh_typesemployeeauditlogentry', 'outsaturday')
    ...
    models = {
        ...
        u'rrhh.employeebreak': {
            ...
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'interval': ('django.db.models.fields.CharField', [], {'max_length': '4', 'primary_key': 'True'}),
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'})
        },
