...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'AssistanceAuditLogEntry.stsemp'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'stsemp_id')

        # Adding field 'AssistanceAuditLogEntry.types'
        db.add_column(u'rrhh_assistanceauditlogentry', 'types',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'_auditlog_AssistanceTypeEmpployee', to=orm['rrhh.TypesEmployee']),
                      keep_default=False)

        # Deleting field 'Assistance.stsemp'
        db.delete_column(u'rrhh_assistance', 'stsemp_id')

        # Adding field 'Assistance.types'
        db.add_column(u'rrhh_assistance', 'types',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='AssistanceTypeEmpployee', to=orm['rrhh.TypesEmployee']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'AssistanceAuditLogEntry.stsemp'
        db.add_column(u'rrhh_assistanceauditlogentry', 'stsemp',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name=u'_auditlog_AssistanceTypeEmpployee', to=orm['rrhh.TypesEmployee']),
                      keep_default=False)

        # Deleting field 'AssistanceAuditLogEntry.types'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'types_id')

        # Adding field 'Assistance.stsemp'
        db.add_column(u'rrhh_assistance', 'stsemp',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='AssistanceTypeEmpployee', to=orm['rrhh.TypesEmployee']),
                      keep_default=False)

        # Deleting field 'Assistance.types'
        db.delete_column(u'rrhh_assistance', 'types_id')
