...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmployeeBreak.payment'
        db.add_column(u'rrhh_employeebreak', 'payment',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmployeeBreak.payment'
        db.delete_column(u'rrhh_employeebreak', 'payment')
