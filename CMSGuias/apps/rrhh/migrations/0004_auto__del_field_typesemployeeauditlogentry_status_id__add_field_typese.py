...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TypesEmployeeAuditLogEntry.status_id'
        db.delete_column(u'rrhh_typesemployeeauditlogentry', 'status_id')

        # Adding field 'TypesEmployeeAuditLogEntry.types_id'
        db.add_column(u'rrhh_typesemployeeauditlogentry', 'types_id',
                      self.gf('django.db.models.fields.CharField')(default='TY00', max_length=4, db_index=True),
                      keep_default=False)

        # Deleting field 'TypesEmployee.status_id'
        db.delete_column(u'rrhh_typesemployee', 'status_id')

        # Adding field 'TypesEmployee.types_id'
        db.add_column(u'rrhh_typesemployee', 'types_id',
                      self.gf('django.db.models.fields.CharField')(default='TY00', max_length=4, primary_key=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TypesEmployeeAuditLogEntry.status_id'
        db.add_column(u'rrhh_typesemployeeauditlogentry', 'status_id',
                      self.gf('django.db.models.fields.CharField')(default='SE00', max_length=4, db_index=True),
                      keep_default=False)

        # Deleting field 'TypesEmployeeAuditLogEntry.types_id'
        db.delete_column(u'rrhh_typesemployeeauditlogentry', 'types_id')

        # Adding field 'TypesEmployee.status_id'
        db.add_column(u'rrhh_typesemployee', 'status_id',
                      self.gf('django.db.models.fields.CharField')(default='SE00', max_length=4, primary_key=True),
                      keep_default=False)

        # Deleting field 'TypesEmployee.types_id'
        db.delete_column(u'rrhh_typesemployee', 'types_id')
