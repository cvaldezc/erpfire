...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'rrhh_balanceassistance', (
            ...
            ('hextfirst', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1)),
            ('hextsecond', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1)),
            ('hwork', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1)),
            ('hdelay', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'rrhh', ['BalanceAssistance'])

        # Deleting field 'AssistanceAuditLogEntry.hdelay'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'hdelay')

        # Deleting field 'AssistanceAuditLogEntry.hextfirst'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'hextfirst')

        # Deleting field 'AssistanceAuditLogEntry.hextsecond'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'hextsecond')

        # Deleting field 'AssistanceAuditLogEntry.hwork'
        db.delete_column(u'rrhh_assistanceauditlogentry', 'hwork')

        # Deleting field 'Assistance.hdelay'
        db.delete_column(u'rrhh_assistance', 'hdelay')

        # Deleting field 'Assistance.hextfirst'
        db.delete_column(u'rrhh_assistance', 'hextfirst')

        # Deleting field 'Assistance.hwork'
        db.delete_column(u'rrhh_assistance', 'hwork')

        # Deleting field 'Assistance.hextsecond'
        db.delete_column(u'rrhh_assistance', 'hextsecond')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'AssistanceAuditLogEntry.hdelay'
        db.add_column(u'rrhh_assistanceauditlogentry', 'hdelay',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1),
                      keep_default=False)

        # Adding field 'AssistanceAuditLogEntry.hextfirst'
        db.add_column(u'rrhh_assistanceauditlogentry', 'hextfirst',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1),
                      keep_default=False)

        # Adding field 'AssistanceAuditLogEntry.hextsecond'
        db.add_column(u'rrhh_assistanceauditlogentry', 'hextsecond',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1),
                      keep_default=False)

        # Adding field 'AssistanceAuditLogEntry.hwork'
        db.add_column(u'rrhh_assistanceauditlogentry', 'hwork',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1),
                      keep_default=False)

        # Adding field 'Assistance.hdelay'
        db.add_column(u'rrhh_assistance', 'hdelay',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1),
                      keep_default=False)

        # Adding field 'Assistance.hextfirst'
        db.add_column(u'rrhh_assistance', 'hextfirst',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1),
                      keep_default=False)

        # Adding field 'Assistance.hwork'
        db.add_column(u'rrhh_assistance', 'hwork',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1),
                      keep_default=False)

        # Adding field 'Assistance.hextsecond'
        db.add_column(u'rrhh_assistance', 'hextsecond',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=3, decimal_places=1),
                      keep_default=False)
