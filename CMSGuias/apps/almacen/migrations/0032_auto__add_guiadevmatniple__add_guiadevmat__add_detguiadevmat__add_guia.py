...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GuiaDevMatNiple'
        db.create_table(u'almacen_guiadevmatniple', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('guiadevmat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat'])),
            ('guia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaRemision'], null=True, blank=True)),
            ...
            ('motivo', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'almacen', ['GuiaDevMatNiple'])

        # Adding model 'GuiaDevMat'
        db.create_table(u'almacen_guiadevmat', (
            ('guiadevmat_id', self.gf('django.db.models.fields.CharField')(max_length=8, primary_key=True)),
            ('fechadevolucion', self.gf('django.db.models.fields.DateField')()),
            ('emple_aut', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='AuthAsEmployee', null=True, to=orm['home.Employee'])),
            ('empdni', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Employee'], null=True, blank=True)),
            ...
            ('estado', self.gf('django.db.models.fields.CharField')(max_length=4, null=True, blank=True)),
            ('registro', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'almacen', ['GuiaDevMat'])

        # Adding model 'detGuiaDevMat'
        db.create_table(u'almacen_detguiadevmat', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('guiadevmat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat'])),
            ('guia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaRemision'], null=True, blank=True)),
            ('material', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale'])),
        ...
        db.send_create_signal(u'almacen', ['detGuiaDevMat'])

        # Adding model 'GuiaDevMatNipleAuditLogEntry'
        db.create_table(u'almacen_guiadevmatnipleauditlogentry', (
            ...
            ('motivo', self.gf('django.db.models.fields.CharField')(max_length=60)),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_guiadevmatniple_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'almacen', ['GuiaDevMatNipleAuditLogEntry'])

        # Adding model 'GuiaDevMatAuditLogEntry'
        db.create_table(u'almacen_guiadevmatauditlogentry', (
            ('guiadevmat_id', self.gf('django.db.models.fields.CharField')(max_length=8, db_index=True)),
            ('fechadevolucion', self.gf('django.db.models.fields.DateField')()),
            ('emple_aut', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'_auditlog_AuthAsEmployee', null=True, to=orm['home.Employee'])),
            ('empdni', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Employee'], null=True, blank=True)),
            ('proyecto', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['ventas.Proyecto'])),
            ('condni', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Conductore'])),
            ('nropla', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Transporte'])),
            ...
            ('registro', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_guiadevmat_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['GuiaDevMatAuditLogEntry'])

        # Adding model 'detGuiaDevMatAuditLogEntry'
        db.create_table(u'almacen_detguiadevmatauditlogentry', (
            (u'id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ('guiadevmat', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat'])),
            ('guia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaRemision'], null=True, blank=True)),
            ('material', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale'])),
            ...
            ('motivo', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_detguiadevmat_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['detGuiaDevMatAuditLogEntry'])

        # Adding field 'DetGuiaRemision.cantdev'
        db.add_column(u'almacen_detguiaremision', 'cantdev',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DetGuiaRemision.stcantdev'
        db.add_column(u'almacen_detguiaremision', 'stcantdev',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NipleAuditLogEntry.cenvdevmat'
        db.add_column(u'almacen_nipleauditlogentry', 'cenvdevmat',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'NipleAuditLogEntry.flagcenvdevmat'
        db.add_column(u'almacen_nipleauditlogentry', 'flagcenvdevmat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'DetGuiaRemisionAuditLogEntry.cantdev'
        db.add_column(u'almacen_detguiaremisionauditlogentry', 'cantdev',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DetGuiaRemisionAuditLogEntry.stcantdev'
        db.add_column(u'almacen_detguiaremisionauditlogentry', 'stcantdev',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Niple.cenvdevmat'
        db.add_column(u'almacen_niple', 'cenvdevmat',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Niple.flagcenvdevmat'
        db.add_column(u'almacen_niple', 'flagcenvdevmat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'GuiaDevMatNiple'
        db.delete_table(u'almacen_guiadevmatniple')

        # Deleting model 'GuiaDevMat'
        db.delete_table(u'almacen_guiadevmat')

        # Deleting model 'detGuiaDevMat'
        db.delete_table(u'almacen_detguiadevmat')

        # Deleting model 'GuiaDevMatNipleAuditLogEntry'
        db.delete_table(u'almacen_guiadevmatnipleauditlogentry')

        # Deleting model 'GuiaDevMatAuditLogEntry'
        db.delete_table(u'almacen_guiadevmatauditlogentry')

        # Deleting model 'detGuiaDevMatAuditLogEntry'
        db.delete_table(u'almacen_detguiadevmatauditlogentry')

        # Deleting field 'DetGuiaRemision.cantdev'
        db.delete_column(u'almacen_detguiaremision', 'cantdev')

        # Deleting field 'DetGuiaRemision.stcantdev'
        db.delete_column(u'almacen_detguiaremision', 'stcantdev')

        # Deleting field 'NipleAuditLogEntry.cenvdevmat'
        db.delete_column(u'almacen_nipleauditlogentry', 'cenvdevmat')

        # Deleting field 'NipleAuditLogEntry.flagcenvdevmat'
        db.delete_column(u'almacen_nipleauditlogentry', 'flagcenvdevmat')

        # Deleting field 'DetGuiaRemisionAuditLogEntry.cantdev'
        db.delete_column(u'almacen_detguiaremisionauditlogentry', 'cantdev')

        # Deleting field 'DetGuiaRemisionAuditLogEntry.stcantdev'
        db.delete_column(u'almacen_detguiaremisionauditlogentry', 'stcantdev')

        # Deleting field 'Niple.cenvdevmat'
        db.delete_column(u'almacen_niple', 'cenvdevmat')

        # Deleting field 'Niple.flagcenvdevmat'
        db.delete_column(u'almacen_niple', 'flagcenvdevmat')
