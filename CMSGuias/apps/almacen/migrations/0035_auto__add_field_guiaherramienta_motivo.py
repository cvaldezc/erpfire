...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GuiaHerramienta.motivo'
        db.add_column(u'almacen_guiaherramienta', 'motivo',
                      self.gf('django.db.models.fields.CharField')(default='AL', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GuiaHerramienta.motivo'
        db.delete_column(u'almacen_guiaherramienta', 'motivo')
    ...
    models = {
        ...
        u'almacen.guiaherramienta': {
            ...
            'proyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Proyecto']"}),
            'registro': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'tipo': ('django.db.models.fields.CharField', [], {'default': "'HE'", 'max_length': '2'}),
            'traruc': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transportista']"})
        },
