...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'detGuiaHerramienta.comentario'
        db.alter_column(u'almacen_detguiaherramienta', 'comentario', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'detGuiaHerramienta.comentario'
        db.alter_column(u'almacen_detguiaherramienta', 'comentario', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))
