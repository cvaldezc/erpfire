...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'GuiaDevMatNiple.idref'
        db.delete_column(u'almacen_guiadevmatniple', 'idref_id')

        # Adding field 'GuiaDevMatNiple.pedido'
        db.add_column(u'almacen_guiadevmatniple', 'pedido',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Pedido'], null=True),
                      keep_default=False)

        # Adding field 'GuiaDevMatNiple.idnipgrem'
        db.add_column(u'almacen_guiadevmatniple', 'idnipgrem',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='idnipAsNipleGuiaRemision', null=True, to=orm['almacen.NipleGuiaRemision']),
                      keep_default=False)


        # Changing field 'GuiaDevMatNiple.guiadevmat'
        db.alter_column(u'almacen_guiadevmatniple', 'guiadevmat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat'], max_length=12))
        # Adding field 'Detpedido.cenvdevmat'
        db.add_column(u'almacen_detpedido', 'cenvdevmat',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'Detpedido.flagcenvdevmat'
        db.add_column(u'almacen_detpedido', 'flagcenvdevmat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'GuiaDevMat.guiadevmat_id'
        db.alter_column(u'almacen_guiadevmat', 'guiadevmat_id', self.gf('django.db.models.fields.CharField')(max_length=12, primary_key=True))
        # Adding field 'detGuiaDevMat.pedido'
        db.add_column(u'almacen_detguiadevmat', 'pedido',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Pedido'], null=True),
                      keep_default=False)

        # Deleting field 'GuiaDevMatNipleAuditLogEntry.idref'
        db.delete_column(u'almacen_guiadevmatnipleauditlogentry', 'idref_id')

        # Adding field 'GuiaDevMatNipleAuditLogEntry.pedido'
        db.add_column(u'almacen_guiadevmatnipleauditlogentry', 'pedido',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Pedido'], null=True),
                      keep_default=False)

        # Adding field 'GuiaDevMatNipleAuditLogEntry.idnipgrem'
        db.add_column(u'almacen_guiadevmatnipleauditlogentry', 'idnipgrem',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_idnipAsNipleGuiaRemision', null=True, to=orm['almacen.NipleGuiaRemision']),
                      keep_default=False)


        # Changing field 'GuiaDevMatNipleAuditLogEntry.guiadevmat'
        db.alter_column(u'almacen_guiadevmatnipleauditlogentry', 'guiadevmat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat'], max_length=12))

        # Changing field 'GuiaDevMatAuditLogEntry.guiadevmat_id'
        db.alter_column(u'almacen_guiadevmatauditlogentry', 'guiadevmat_id', self.gf('django.db.models.fields.CharField')(max_length=12))
        # Adding field 'detGuiaDevMatAuditLogEntry.pedido'
        db.add_column(u'almacen_detguiadevmatauditlogentry', 'pedido',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Pedido'], null=True),
                      keep_default=False)

        # Adding field 'DetpedidoAuditLogEntry.cenvdevmat'
        db.add_column(u'almacen_detpedidoauditlogentry', 'cenvdevmat',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'DetpedidoAuditLogEntry.flagcenvdevmat'
        db.add_column(u'almacen_detpedidoauditlogentry', 'flagcenvdevmat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'NipleGuiaRemision.cenvdevmat'
        db.add_column(u'almacen_nipleguiaremision', 'cenvdevmat',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)

        # Adding field 'NipleGuiaRemision.flagcenvdevmat'
        db.add_column(u'almacen_nipleguiaremision', 'flagcenvdevmat',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'GuiaDevMatNiple.idref'
        db.add_column(u'almacen_guiadevmatniple', 'idref',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['almacen.Niple']),
                      keep_default=False)

        # Deleting field 'GuiaDevMatNiple.pedido'
        db.delete_column(u'almacen_guiadevmatniple', 'pedido_id')

        # Deleting field 'GuiaDevMatNiple.idnipgrem'
        db.delete_column(u'almacen_guiadevmatniple', 'idnipgrem_id')


        # Changing field 'GuiaDevMatNiple.guiadevmat'
        db.alter_column(u'almacen_guiadevmatniple', 'guiadevmat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat']))
        # Deleting field 'Detpedido.cenvdevmat'
        db.delete_column(u'almacen_detpedido', 'cenvdevmat')

        # Deleting field 'Detpedido.flagcenvdevmat'
        db.delete_column(u'almacen_detpedido', 'flagcenvdevmat')


        # Changing field 'GuiaDevMat.guiadevmat_id'
        db.alter_column(u'almacen_guiadevmat', 'guiadevmat_id', self.gf('django.db.models.fields.CharField')(max_length=8, primary_key=True))
        # Deleting field 'detGuiaDevMat.pedido'
        db.delete_column(u'almacen_detguiadevmat', 'pedido_id')

        # Adding field 'GuiaDevMatNipleAuditLogEntry.idref'
        db.add_column(u'almacen_guiadevmatnipleauditlogentry', 'idref',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['almacen.Niple']),
                      keep_default=False)

        # Deleting field 'GuiaDevMatNipleAuditLogEntry.pedido'
        db.delete_column(u'almacen_guiadevmatnipleauditlogentry', 'pedido_id')

        # Deleting field 'GuiaDevMatNipleAuditLogEntry.idnipgrem'
        db.delete_column(u'almacen_guiadevmatnipleauditlogentry', 'idnipgrem_id')


        # Changing field 'GuiaDevMatNipleAuditLogEntry.guiadevmat'
        db.alter_column(u'almacen_guiadevmatnipleauditlogentry', 'guiadevmat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat']))

        # Changing field 'GuiaDevMatAuditLogEntry.guiadevmat_id'
        db.alter_column(u'almacen_guiadevmatauditlogentry', 'guiadevmat_id', self.gf('django.db.models.fields.CharField')(max_length=8))
        # Deleting field 'detGuiaDevMatAuditLogEntry.pedido'
        db.delete_column(u'almacen_detguiadevmatauditlogentry', 'pedido_id')

        # Deleting field 'DetpedidoAuditLogEntry.cenvdevmat'
        db.delete_column(u'almacen_detpedidoauditlogentry', 'cenvdevmat')

        # Deleting field 'DetpedidoAuditLogEntry.flagcenvdevmat'
        db.delete_column(u'almacen_detpedidoauditlogentry', 'flagcenvdevmat')

        # Deleting field 'NipleGuiaRemision.cenvdevmat'
        db.delete_column(u'almacen_nipleguiaremision', 'cenvdevmat')

        # Deleting field 'NipleGuiaRemision.flagcenvdevmat'
        db.delete_column(u'almacen_nipleguiaremision', 'flagcenvdevmat')
    ...
    models = {
        ...
        u'almacen.detguiadevmat': {
            ...
            'pedido': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.Pedido']", 'null': 'True'})
        },
        ...
        u'almacen.grupopedniple': {
            ...
            'codgrupo': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GrupoPedido']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idref': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'idrefAsGroupPedNiple'", 'to': u"orm['almacen.Niple']"}),
            'marca': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Brand']"}),
            'material': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Materiale']"}),
        ...
        u'almacen.guiadevmat': {
            ...
            'guiadevmat_id': ('django.db.models.fields.CharField', [], {'max_length': '12', 'primary_key': 'True'}),
            'nropla': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transporte']"}),
            'proyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Proyecto']"}),
            'registro': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'traruc': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transportista']"})
        ...
        u'almacen.guiadevmatauditlogentry': {
            ...
            'estado': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'fechadevolucion': ('django.db.models.fields.DateField', [], {}),
            'guiadevmat_id': ('django.db.models.fields.CharField', [], {'max_length': '12', 'db_index': 'True'}),
            'nropla': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transporte']"}),
            'proyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Proyecto']"}),
            'registro': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'traruc': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transportista']"})
        ...
        u'almacen.guiadevmatniple': {
            ...
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'guia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaRemision']", 'null': 'True', 'blank': 'True'}),
            'guiadevmat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaDevMat']", 'max_length': '12'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'idnipgrem': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'idnipAsNipleGuiaRemision'", 'null': 'True', 'to': u"orm['almacen.NipleGuiaRemision']"}),
            'marca': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Brand']"}),
            'material': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Materiale']"}),
            'metrado': ('django.db.models.fields.FloatField', [], {}),
            'model': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Model']"}),
        ...
        u'almacen.guiadevmatnipleauditlogentry': {
            ...
            'guiadevmat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaDevMat']", 'max_length': '12'}),
            u'id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'blank': 'True'}),
            'idnipgrem': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'_auditlog_idnipAsNipleGuiaRemision'", 'null': 'True', 'to': u"orm['almacen.NipleGuiaRemision']"}),
            'marca': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Brand']"}),
            'material': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Materiale']"}),
            'metrado': ('django.db.models.fields.FloatField', [], {}),
            'model': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Model']"}),
        ...
        u'almacen.guiaherramienta': {
            ...
            'motivo': ('django.db.models.fields.CharField', [], {'default': "'AL'", 'max_length': '2'}),
            'nropla': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transporte']"}),
            'proyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Proyecto']"}),
            'registro': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'tipo': ('django.db.models.fields.CharField', [], {'default': "'TL'", 'max_length': '2'}),
            'traruc': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transportista']"})
        },
        ...
        u'home.materiale': {
            ...
            'materiales_id': ('django.db.models.fields.CharField', [], {'max_length': '15', 'primary_key': 'True'}),
