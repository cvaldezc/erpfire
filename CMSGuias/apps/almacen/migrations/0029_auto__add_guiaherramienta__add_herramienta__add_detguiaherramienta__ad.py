...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'GuiaHerramienta'
        db.create_table(u'almacen_guiaherramienta', (
            ...
            ('fechsalida', self.gf('django.db.models.fields.DateField')()),
            ('empdni', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Employee'], null=True)),
        ...
        db.send_create_signal(u'almacen', ['GuiaHerramienta'])
        ...
        # Adding model 'detGuiaHerramienta'
        db.create_table(u'almacen_detguiaherramienta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('guia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaHerramienta'])),
            ('herramienta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Herramienta'])),
            ('estado', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('fechdevolucion', self.gf('django.db.models.fields.DateField')(null=True, blank=True)),
            ('cantidad', self.gf('django.db.models.fields.FloatField')()),
            ('cantdev', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('flagdev', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'almacen', ['detGuiaHerramienta'])

        # Adding model 'MovInventario'
        db.create_table(u'almacen_movinventario', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('herramienta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Herramienta'])),
            ('cantidad', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('estado', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('registro', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'almacen', ['MovInventario'])

        # Adding model 'InventarioHerra'
        db.create_table(u'almacen_inventarioherra', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('herramienta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Herramienta'])),
            ('registro', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ...
            ('observacion', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('cantalmacen', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
        ))
        db.send_create_signal(u'almacen', ['InventarioHerra'])

        # Adding model 'detDevHerramienta'
        db.create_table(u'almacen_detdevherramienta', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('guia', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaHerramienta'])),
            ('docdev', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.devolucionHerra'])),
            ('herramienta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Herramienta'])),
            ('cantidad', self.gf('django.db.models.fields.FloatField')()),
            ('estado', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'almacen', ['detDevHerramienta'])

        # Adding model 'ReparacionHerra'
        db.create_table(u'almacen_reparacionherra', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('herramienta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Herramienta'])),
            ('cantidad', self.gf('django.db.models.fields.FloatField')()),
            ('fechreparacion', self.gf('django.db.models.fields.DateField')()),
            ('registro', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('lugarreparacion', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ))
        db.send_create_signal(u'almacen', ['ReparacionHerra'])

        # Adding model 'devolucionHerra'
        db.create_table(u'almacen_devolucionherra', (
            ('docdev_id', self.gf('django.db.models.fields.CharField')(max_length=12, primary_key=True)),
            ('fechretorno', self.gf('django.db.models.fields.DateField')()),
            ('registro', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ...
        db.send_create_signal(u'almacen', ['devolucionHerra'])


    def backwards(self, orm):
        # Deleting model 'GuiaHerramienta'
        db.delete_table(u'almacen_guiaherramienta')

        # Deleting model 'Herramienta'
        db.delete_table(u'almacen_herramienta')

        # Deleting model 'detGuiaHerramienta'
        db.delete_table(u'almacen_detguiaherramienta')

        # Deleting model 'MovInventario'
        db.delete_table(u'almacen_movinventario')

        # Deleting model 'InventarioHerra'
        db.delete_table(u'almacen_inventarioherra')

        # Deleting model 'detDevHerramienta'
        db.delete_table(u'almacen_detdevherramienta')

        # Deleting model 'ReparacionHerra'
        db.delete_table(u'almacen_reparacionherra')

        # Deleting model 'devolucionHerra'
        db.delete_table(u'almacen_devolucionherra')
