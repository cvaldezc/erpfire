...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'almacen_herramienta')

        # Adding model 'DetIngresoHe'
        db.create_table(u'almacen_detingresohe', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('ingresohe', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.NotaIngresoHe'])),
            ('herramienta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale'])),
            ...
            ('convertto', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'almacen', ['DetIngresoHe'])

        # Adding model 'NotaIngresoHe'
        db.create_table(u'almacen_notaingresohe', (
            ('ingresohe_id', self.gf('django.db.models.fields.CharField')(max_length=10, primary_key=True)),
            ...
            ('guia', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('factura', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('motivo', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('registro', self.gf('django.db.models.fields.related.ForeignKey')(related_name='registroHeAsEmployee', to=orm['home.Employee'])),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('recibido', self.gf('django.db.models.fields.related.ForeignKey')(related_name='receiveHeAsEmployee', to=orm['home.Employee'])),
            ('inspeccionado', self.gf('django.db.models.fields.related.ForeignKey')(related_name='inspectionHeAsEmployee', to=orm['home.Employee'])),
            ('aprobado', self.gf('django.db.models.fields.related.ForeignKey')(related_name='approvalHeAsEmployee', to=orm['home.Employee'])),
        ...
        db.send_create_signal(u'almacen', ['NotaIngresoHe'])

        # Adding model 'DetIngresoHeAuditLogEntry'
        db.create_table(u'almacen_detingresoheauditlogentry', (
            ...
            ('convertto', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_detingresohe_audit_log_entry', to=orm['auth.User'])),
        ...
        db.send_create_signal(u'almacen', ['DetIngresoHeAuditLogEntry'])

        # Adding model 'NotaIngresoHeAuditLogEntry'
        db.create_table(u'almacen_notaingresoheauditlogentry', (
            ('ingresohe_id', self.gf('django.db.models.fields.CharField')(max_length=10, db_index=True)),
            ('almacen', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Almacene'])),
            ('compra', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['logistica.Compra'])),
            ('guia', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('factura', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, blank=True)),
            ('motivo', self.gf('django.db.models.fields.CharField')(max_length=60, null=True, blank=True)),
            ('registro', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_registroHeAsEmployee', to=orm['home.Employee'])),
            ('register', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('recibido', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_receiveHeAsEmployee', to=orm['home.Employee'])),
            ('inspeccionado', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_inspectionHeAsEmployee', to=orm['home.Employee'])),
            ('aprobado', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'_auditlog_approvalHeAsEmployee', to=orm['home.Employee'])),
            ('comentario', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('estado', self.gf('django.db.models.fields.CharField')(default='PE', max_length=2)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_notaingresohe_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['NotaIngresoHeAuditLogEntry'])

        # Adding model 'InventarioHerraAuditLogEntry'
        db.create_table(u'almacen_inventarioherraauditlogentry', (
            (u'id', self.gf('django.db.models.fields.IntegerField')(db_index=True, blank=True)),
            ('herramienta', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale'])),
            ('marca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Brand'])),
            ('registro', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('ingreso', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
            ('reparacion', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
            ('cantalmacen', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
            ('moneda', self.gf('django.db.models.fields.related.ForeignKey')(default='CU02', to=orm['home.Moneda'])),
            ('price', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('tvida', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('flag', self.gf('django.db.models.fields.BooleanField')(default=True)),
            (u'action_user', self.gf('audit_log.models.fields.LastUserField')(related_name=u'_inventarioherra_audit_log_entry', to=orm['auth.User'])),
            (u'action_id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            (u'action_date', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            (u'action_type', self.gf('django.db.models.fields.CharField')(max_length=1)),
        ))
        db.send_create_signal(u'almacen', ['InventarioHerraAuditLogEntry'])

        # Adding field 'detGuiaHerramienta.brand'
        db.add_column(u'almacen_detguiaherramienta', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='BR000', to=orm['home.Brand']),
                      keep_default=False)

        # Adding field 'detGuiaHerramienta.grupo'
        db.add_column(u'almacen_detguiaherramienta', 'grupo',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'detGuiaHerramienta.cantinicial'
        db.add_column(u'almacen_detguiaherramienta', 'cantinicial',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


        # Changing field 'detGuiaHerramienta.herramienta'
        db.alter_column(u'almacen_detguiaherramienta', 'herramienta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale']))

        # Changing field 'MovInventario.herramienta'
        db.alter_column(u'almacen_movinventario', 'herramienta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale']))
        # Deleting field 'InventarioHerra.observacion'
        db.delete_column(u'almacen_inventarioherra', 'observacion')

        # Adding field 'InventarioHerra.marca'
        db.add_column(u'almacen_inventarioherra', 'marca',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='BR000', to=orm['home.Brand']),
                      keep_default=False)

        # Adding field 'InventarioHerra.moneda'
        db.add_column(u'almacen_inventarioherra', 'moneda',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='CU02', to=orm['home.Moneda']),
                      keep_default=False)

        # Adding field 'InventarioHerra.tvida'
        db.add_column(u'almacen_inventarioherra', 'tvida',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'InventarioHerra.flag'
        db.add_column(u'almacen_inventarioherra', 'flag',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'InventarioHerra.herramienta'
        db.alter_column(u'almacen_inventarioherra', 'herramienta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale']))
        # Adding field 'detDevHerramienta.brand'
        db.add_column(u'almacen_detdevherramienta', 'brand',
                      self.gf('django.db.models.fields.related.ForeignKey')(default='BR000', to=orm['home.Brand']),
                      keep_default=False)

        # Adding field 'detDevHerramienta.flag'
        db.add_column(u'almacen_detdevherramienta', 'flag',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


        # Changing field 'detDevHerramienta.herramienta'
        db.alter_column(u'almacen_detdevherramienta', 'herramienta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale']))

        # Changing field 'ReparacionHerra.herramienta'
        db.alter_column(u'almacen_reparacionherra', 'herramienta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Materiale']))

    def backwards(self, orm):
        # Adding model 'Herramienta'
        db.create_table(u'almacen_herramienta', (
            ('tvida', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True)),
            ('marca', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Brand'])),
            ('herramienta_id', self.gf('django.db.models.fields.CharField')(max_length=15, primary_key=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('medida', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('unidad', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['home.Unidade'])),
        ))
        db.send_create_signal(u'almacen', ['Herramienta'])

        # Deleting model 'DetIngresoHe'
        db.delete_table(u'almacen_detingresohe')

        # Deleting model 'NotaIngresoHe'
        db.delete_table(u'almacen_notaingresohe')

        # Deleting model 'DetIngresoHeAuditLogEntry'
        db.delete_table(u'almacen_detingresoheauditlogentry')

        # Deleting model 'NotaIngresoHeAuditLogEntry'
        db.delete_table(u'almacen_notaingresoheauditlogentry')

        # Deleting model 'InventarioHerraAuditLogEntry'
        db.delete_table(u'almacen_inventarioherraauditlogentry')

        # Deleting field 'detGuiaHerramienta.brand'
        db.delete_column(u'almacen_detguiaherramienta', 'brand_id')

        # Deleting field 'detGuiaHerramienta.grupo'
        db.delete_column(u'almacen_detguiaherramienta', 'grupo')

        # Deleting field 'detGuiaHerramienta.cantinicial'
        db.delete_column(u'almacen_detguiaherramienta', 'cantinicial')


        # Changing field 'detGuiaHerramienta.herramienta'
        db.alter_column(u'almacen_detguiaherramienta', 'herramienta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Herramienta']))

        # Changing field 'MovInventario.herramienta'
        db.alter_column(u'almacen_movinventario', 'herramienta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Herramienta']))
        # Adding field 'InventarioHerra.observacion'
        db.add_column(u'almacen_inventarioherra', 'observacion',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'InventarioHerra.marca'
        db.delete_column(u'almacen_inventarioherra', 'marca_id')

        # Deleting field 'InventarioHerra.moneda'
        db.delete_column(u'almacen_inventarioherra', 'moneda_id')

        # Deleting field 'InventarioHerra.tvida'
        db.delete_column(u'almacen_inventarioherra', 'tvida')

        # Deleting field 'InventarioHerra.flag'
        db.delete_column(u'almacen_inventarioherra', 'flag')


        # Changing field 'InventarioHerra.herramienta'
        db.alter_column(u'almacen_inventarioherra', 'herramienta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Herramienta']))
        # Deleting field 'detDevHerramienta.brand'
        db.delete_column(u'almacen_detdevherramienta', 'brand_id')

        # Deleting field 'detDevHerramienta.flag'
        db.delete_column(u'almacen_detdevherramienta', 'flag')


        # Changing field 'detDevHerramienta.herramienta'
        db.alter_column(u'almacen_detdevherramienta', 'herramienta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Herramienta']))

        # Changing field 'ReparacionHerra.herramienta'
        db.alter_column(u'almacen_reparacionherra', 'herramienta_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.Herramienta']))
    ...
    models = {
        ...
        u'almacen.detdevherramienta': {
            ...
            'herramienta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Materiale']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'})
        },
        ...
        u'almacen.detguiadevmat': {
            'Meta': {'object_name': 'detGuiaDevMat'},
            'cantidad': ('django.db.models.fields.FloatField', [], {}),
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'guia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaRemision']", 'null': 'True', 'blank': 'True'}),
            'guiadevmat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaDevMat']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'marca': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Brand']"}),
            'material': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Materiale']"}),
            'model': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Model']"}),
            'motivo': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'})
        },
        u'almacen.detguiadevmatauditlogentry': {
            'Meta': {'ordering': "(u'-action_date',)", 'object_name': 'detGuiaDevMatAuditLogEntry'},
            u'action_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'action_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'action_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'action_user': ('audit_log.models.fields.LastUserField', [], {'related_name': "u'_detguiadevmat_audit_log_entry'", 'to': u"orm['auth.User']"}),
            'cantidad': ('django.db.models.fields.FloatField', [], {}),
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'guia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaRemision']", 'null': 'True', 'blank': 'True'}),
            'guiadevmat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaDevMat']"}),
        ...
        u'almacen.detguiaherramienta': {
            ...
            'cantidad': ('django.db.models.fields.FloatField', [], {}),
            'cantinicial': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
        ...
        u'almacen.detingresohe': {
            'Meta': {'object_name': 'DetIngresoHe'},
            'cantidad': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'convertto': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'herramienta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Materiale']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ingresohe': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.NotaIngresoHe']"}),
            'marca': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Brand']"})
        },
        u'almacen.detingresoheauditlogentry': {
            'Meta': {'ordering': "(u'-action_date',)", 'object_name': 'DetIngresoHeAuditLogEntry'},
            u'action_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'action_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'action_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'action_user': ('audit_log.models.fields.LastUserField', [], {'related_name': "u'_detingresohe_audit_log_entry'", 'to': u"orm['auth.User']"}),
            'cantidad': ('django.db.models.fields.DecimalField', [], {'max_digits': '8', 'decimal_places': '2'}),
            'convertto': ('django.db.models.fields.DecimalField', [], {'max_digits': '6', 'decimal_places': '2'}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'herramienta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Materiale']"}),
        ...
        u'almacen.guiadevmat': {
            'Meta': {'object_name': 'GuiaDevMat'},
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'condni': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Conductore']"}),
            'empdni': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Employee']", 'null': 'True', 'blank': 'True'}),
            'emple_aut': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'AuthAsEmployee'", 'null': 'True', 'to': u"orm['home.Employee']"}),
            'estado': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'fechadevolucion': ('django.db.models.fields.DateField', [], {}),
            'guiadevmat_id': ('django.db.models.fields.CharField', [], {'max_length': '8', 'primary_key': 'True'}),
            'nropla': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transporte']"}),
            'proyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Proyecto']"}),
            'registro': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'traruc': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transportista']"})
        },
        u'almacen.guiadevmatauditlogentry': {
            'Meta': {'ordering': "(u'-action_date',)", 'object_name': 'GuiaDevMatAuditLogEntry'},
            u'action_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'action_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'action_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'action_user': ('audit_log.models.fields.LastUserField', [], {'related_name': "u'_guiadevmat_audit_log_entry'", 'to': u"orm['auth.User']"}),
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'condni': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Conductore']"}),
            'empdni': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Employee']", 'null': 'True', 'blank': 'True'}),
            'emple_aut': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "u'_auditlog_AuthAsEmployee'", 'null': 'True', 'to': u"orm['home.Employee']"}),
            'estado': ('django.db.models.fields.CharField', [], {'max_length': '4', 'null': 'True', 'blank': 'True'}),
            'fechadevolucion': ('django.db.models.fields.DateField', [], {}),
            'guiadevmat_id': ('django.db.models.fields.CharField', [], {'max_length': '8', 'db_index': 'True'}),
            'nropla': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transporte']"}),
            'proyecto': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['ventas.Proyecto']"}),
            'registro': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'traruc': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Transportista']"})
        },
        u'almacen.guiadevmatniple': {
            'Meta': {'object_name': 'GuiaDevMatNiple'},
            'cantidad': ('django.db.models.fields.FloatField', [], {}),
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'guia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaRemision']", 'null': 'True', 'blank': 'True'}),
            'guiadevmat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaDevMat']"}),
            ...
            'metrado': ('django.db.models.fields.FloatField', [], {}),
            'model': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Model']"}),
            'motivo': ('django.db.models.fields.CharField', [], {'max_length': '60'}),
            'tipo': ('django.db.models.fields.CharField', [], {'max_length': '1'})
        },
        u'almacen.guiadevmatnipleauditlogentry': {
            'Meta': {'ordering': "(u'-action_date',)", 'object_name': 'GuiaDevMatNipleAuditLogEntry'},
            u'action_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'action_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'action_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'action_user': ('audit_log.models.fields.LastUserField', [], {'related_name': "u'_guiadevmatniple_audit_log_entry'", 'to': u"orm['auth.User']"}),
            'cantidad': ('django.db.models.fields.FloatField', [], {}),
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'guia': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaRemision']", 'null': 'True', 'blank': 'True'}),
            'guiadevmat': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['almacen.GuiaDevMat']"}),
        ...
        u'almacen.inventarioherra': {
            ...
            'marca': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Brand']"}),
            'moneda': ('django.db.models.fields.related.ForeignKey', [], {'default': "'CU02'", 'to': u"orm['home.Moneda']"}),
        ...
        u'almacen.inventarioherraauditlogentry': {
            'Meta': {'ordering': "(u'-action_date',)", 'object_name': 'InventarioHerraAuditLogEntry'},
            u'action_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'action_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'action_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'action_user': ('audit_log.models.fields.LastUserField', [], {'related_name': "u'_inventarioherra_audit_log_entry'", 'to': u"orm['auth.User']"}),
            'cantalmacen': ('django.db.models.fields.FloatField', [], {'default': '0', 'null': 'True', 'blank': 'True'}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'herramienta': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Materiale']"}),
            u'id': ('django.db.models.fields.IntegerField', [], {'db_index': 'True', 'blank': 'True'}),
        ...
        u'almacen.niple': {
            ...
            'cenvdevmat': ('django.db.models.fields.FloatField', [], {'default': '0'}),
            ...
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'flagcantenv': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'flagcenvdevmat': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'materiales': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Materiale']"}),
        ...
        u'almacen.notaingresohe': {
            'Meta': {'object_name': 'NotaIngresoHe'},
            'almacen': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Almacene']"}),
            'aprobado': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'approvalHeAsEmployee'", 'to': u"orm['home.Employee']"}),
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'factura': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'guia': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'ingresohe_id': ('django.db.models.fields.CharField', [], {'max_length': '10', 'primary_key': 'True'}),
            'inspeccionado': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'inspectionHeAsEmployee'", 'to': u"orm['home.Employee']"}),
            'motivo': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            'recibido': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'receiveHeAsEmployee'", 'to': u"orm['home.Employee']"}),
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'registro': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'registroHeAsEmployee'", 'to': u"orm['home.Employee']"})
        },
        u'almacen.notaingresoheauditlogentry': {
            'Meta': {'ordering': "(u'-action_date',)", 'object_name': 'NotaIngresoHeAuditLogEntry'},
            u'action_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            u'action_id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            u'action_type': ('django.db.models.fields.CharField', [], {'max_length': '1'}),
            u'action_user': ('audit_log.models.fields.LastUserField', [], {'related_name': "u'_notaingresohe_audit_log_entry'", 'to': u"orm['auth.User']"}),
            'almacen': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['home.Almacene']"}),
            'aprobado': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'_auditlog_approvalHeAsEmployee'", 'to': u"orm['home.Employee']"}),
            'comentario': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            'compra': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['logistica.Compra']"}),
            'estado': ('django.db.models.fields.CharField', [], {'default': "'PE'", 'max_length': '2'}),
            'factura': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'flag': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'guia': ('django.db.models.fields.CharField', [], {'max_length': '12', 'null': 'True', 'blank': 'True'}),
            'ingresohe_id': ('django.db.models.fields.CharField', [], {'max_length': '10', 'db_index': 'True'}),
            'inspeccionado': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'_auditlog_inspectionHeAsEmployee'", 'to': u"orm['home.Employee']"}),
            'motivo': ('django.db.models.fields.CharField', [], {'max_length': '60', 'null': 'True', 'blank': 'True'}),
            'recibido': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'_auditlog_receiveHeAsEmployee'", 'to': u"orm['home.Employee']"}),
            'register': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'registro': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'_auditlog_registroHeAsEmployee'", 'to': u"orm['home.Employee']"})
        },
