...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DetIngress.convertto'
        db.alter_column(u'almacen_detingress', 'convertto', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

        # Changing field 'DetIngressAuditLogEntry.convertto'
        db.alter_column(u'almacen_detingressauditlogentry', 'convertto', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'DetIngress.convertto'
        db.alter_column(u'almacen_detingress', 'convertto', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))

        # Changing field 'DetIngressAuditLogEntry.convertto'
        db.alter_column(u'almacen_detingressauditlogentry', 'convertto', self.gf('django.db.models.fields.DecimalField')(max_digits=8, decimal_places=2))
