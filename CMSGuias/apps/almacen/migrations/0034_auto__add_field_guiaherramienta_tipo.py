...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'GuiaHerramienta.tipo'
        db.add_column(u'almacen_guiaherramienta', 'tipo',
                      self.gf('django.db.models.fields.CharField')(default='HE', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'GuiaHerramienta.tipo'
        db.delete_column(u'almacen_guiaherramienta', 'tipo')
