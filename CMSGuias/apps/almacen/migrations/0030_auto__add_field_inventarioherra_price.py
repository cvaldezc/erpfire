...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InventarioHerra.price'
        db.add_column(u'almacen_inventarioherra', 'price',
                      self.gf('django.db.models.fields.FloatField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InventarioHerra.price'
        db.delete_column(u'almacen_inventarioherra', 'price')
