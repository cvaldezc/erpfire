...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'detGuiaDevMat.guiadevmat'
        db.alter_column(u'almacen_detguiadevmat', 'guiadevmat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat'], max_length=12))

        # Changing field 'detGuiaDevMatAuditLogEntry.guiadevmat'
        db.alter_column(u'almacen_detguiadevmatauditlogentry', 'guiadevmat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat'], max_length=12))

    def backwards(self, orm):

        # Changing field 'detGuiaDevMat.guiadevmat'
        db.alter_column(u'almacen_detguiadevmat', 'guiadevmat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat']))

        # Changing field 'detGuiaDevMatAuditLogEntry.guiadevmat'
        db.alter_column(u'almacen_detguiadevmatauditlogentry', 'guiadevmat_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['almacen.GuiaDevMat']))
