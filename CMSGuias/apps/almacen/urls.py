...
urlpatterns = patterns(
    ...
    url(r'^list/orders/approved/$', view_orders_list_approved, name='vista_list_approved'),
    ...
    url(r'^keep/customers/(?P<ruc>\w{11})/edit/$', view_keep_edit_customers,
    ...
    url(r'^order/attend/(?P<order>\w{10})/$',
        AttendOrder.as_view(), name='vista_meet_order'),
    url(r'^load/inventory/$', LoadInventoryBrand.as_view(),
        name='vista_inventory'),
